...
impl Peripherals {
    ...
    #[inline]
    pub fn read_control_actlr_disoofp(&self) -> MemResult<bool> {
        todo!("read Control ACTLR DISOOFP reset value false")
    }
    #[doc = "Control ACTLR DISOOFP: Disables floating point instructions completing out of order with respect to integer instructions"]
    #[inline]
    pub fn write_control_actlr_disoofp(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_actlr_disfpca(&self) -> MemResult<bool> {
        todo!("read Control ACTLR DISFPCA reset value false")
    }
    #[doc = "Control ACTLR DISFPCA: Disable automatic update of CONTROL.FPCA"]
    #[inline]
    pub fn write_control_actlr_disfpca(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_actlr_disfold(&self) -> MemResult<bool> {
        todo!("read Control ACTLR DISFOLD reset value false")
    }
    #[doc = "Control ACTLR DISFOLD: Disables folding of IT instructions"]
    #[inline]
    pub fn write_control_actlr_disfold(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_actlr_disdefwbuf(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_actlr_dismcycint(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_nmipendset(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_pendsvset(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_pendsvclr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_pendstset(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_pendstclr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_isrpreempt(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_isrpending(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_vectpending(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_control_icsr_rettobase(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_icsr_vectactive(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_control_vtor_tbloff(&self) -> MemResult<u32> {
        todo!("read Control VTOR TBLOFF reset value 0x00 mask 0x1ffffff")
    }
    #[doc = "Control VTOR TBLOFF: Bits [31:7] of the vector table address"]
    #[inline]
    pub fn write_control_vtor_tbloff(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_vtor_tblbase(&self) -> MemResult<bool> {
        todo!("read Control VTOR TBLBASE reset value false")
    }
    #[doc = "Control VTOR TBLBASE: Determines whether the vector table is in the code or SRAM memory region"]
    #[inline]
    pub fn write_control_vtor_tblbase(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_demcr_mon_en(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_aircr_endianness(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_aircr_sysresetreq(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_aircr_vectclractive(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_scr_sevonpend(&self) -> MemResult<bool> {
        Ok(self.control.event_on_pending())
    }
    #[doc = "Control SCR SEVONPEND: Determines whether an interrupt transition from inactive state to pending state is a wakeup event"]
    #[inline]
    pub fn write_control_scr_sevonpend(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_scr_sleepdeep(&self) -> MemResult<bool> {
        Ok(self.control.sleep_deep())
    }
    #[doc = "Control SCR SLEEPDEEP: Hint indicating that waking from sleep might take longer"]
    #[inline]
    pub fn write_control_scr_sleepdeep(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_scr_sleeponexit(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_ccr_stkalign(&self) -> MemResult<bool> {
        todo!("read Control CCR STKALIGN reset value false")
    }
    #[doc = "Control CCR STKALIGN: Determines whether the exception entry sequence guarantees 8-byte stack frame alignment, adjusting the SP if necessary before saving state"]
    #[inline]
    pub fn write_control_ccr_stkalign(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_ccr_bfhfnmign(&self) -> MemResult<bool> {
        todo!("read Control CCR BFHFNMIGN reset value false")
    }
    #[doc = "Control CCR BFHFNMIGN: Determines the effect of precise data access faults on handlers running at priority -1 or priority -2"]
    #[inline]
    pub fn write_control_ccr_bfhfnmign(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_ccr_div_0_trp(&self) -> MemResult<bool> {
        todo!("read Control CCR DIV_0_TRP reset value false")
    }
    #[doc = "Control CCR DIV_0_TRP: Controls the trap on divide by 0"]
    #[inline]
    pub fn write_control_ccr_div_0_trp(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_ccr_unalign_trp(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_ccr_usersetmpend(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_ccr_nonbasethrdena(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_usgfaultena(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_busfaultena(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_memfaultena(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_svcallpended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_busfaultpended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_memfaultpended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_usgfaultpended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_systickact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_pendsvact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_monitoract(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_svcallact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_usgfaultact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_busfaultact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_shcsr_memfaultact(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_divbyzero(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_unaligned(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_nocp(&self) -> MemResult<bool> {
        todo!("read Control CFSR NOCP reset value false")
    }
    #[doc = "Control CFSR NOCP: Coprocessor access error"]
    #[inline]
    pub fn write_control_cfsr_nocp(&mut self, _value: bool) -> MemResult<()> {
        todo!("write Control CFSR NOCP reset value false")
    }
    #[doc = "Control CFSR INVPC: Integrity check error on EXC_RETURN"]
    #[inline]
    pub fn read_control_cfsr_invpc(&self) -> MemResult<bool> {
        todo!("read Control CFSR INVPC reset value false")
    }
    #[doc = "Control CFSR INVPC: Integrity check error on EXC_RETURN"]
    #[inline]
    pub fn write_control_cfsr_invpc(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_invstate(&self) -> MemResult<bool> {
        todo!("read Control CFSR INVSTATE reset value false")
    }
    #[doc = "Control CFSR INVSTATE: Instruction executed with invalid EPSR.T or EPSR.IT field"]
    #[inline]
    pub fn write_control_cfsr_invstate(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_undefinstr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_bfarvalid(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_impreciserr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_preciserr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_ibuserr(&self) -> MemResult<bool> {
        todo!("read Control CFSR IBUSERR reset value false")
    }
    #[doc = "Control CFSR IBUSERR: Bus fault on an instruction prefetch"]
    #[inline]
    pub fn write_control_cfsr_ibuserr(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_mmarvalid(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_mlsperr(&self) -> MemResult<bool> {
        todo!("read Control CFSR MLSPERR reset value false")
    }
    #[doc = "Control CFSR MLSPERR: MemManage fault during FP lazy state preservation"]
    #[inline]
    pub fn write_control_cfsr_mlsperr(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_mstkerr(&self) -> MemResult<bool> {
        todo!("read Control CFSR MSTKERR reset value false")
    }
    #[doc = "Control CFSR MSTKERR: Derived MemManage fault on exception entry"]
    #[inline]
    pub fn write_control_cfsr_mstkerr(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_munstkerr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_control_cfsr_daccviol(&self) -> MemResult<bool> {
        todo!("read Control CFSR DACCVIOL reset value false")
    }
    #[doc = "Control CFSR DACCVIOL: Data access violation. The MMAR shows the data address that the load or store tried to access"]
    #[inline]
    pub fn write_control_cfsr_daccviol(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_cfsr_iaccviol(&self) -> MemResult<bool> {
        todo!("read Control CFSR IACCVIOL reset value false")
    }
    #[doc = "Control CFSR IACCVIOL: MPU or Execute Never (XN) default memory map access violation on an instruction fetch"]
    #[inline]
    pub fn write_control_cfsr_iaccviol(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_hfsr_debugevt(&self) -> MemResult<bool> {
        todo!("read Control HFSR DEBUGEVT reset value false")
    }
    #[doc = "Control HFSR DEBUGEVT: Indicates a Debug event has occurred"]
    #[inline]
    pub fn write_control_hfsr_debugevt(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_hfsr_forced(&self) -> MemResult<bool> {
        todo!("read Control HFSR FORCED reset value false")
    }
    #[doc = "Control HFSR FORCED: Indicates a fault with configurable priority has been escalated to a HardFault"]
    #[inline]
    pub fn write_control_hfsr_forced(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_hfsr_vecttbl(&self) -> MemResult<bool> {
        todo!("read Control HFSR VECTTBL reset value false")
    }
    #[doc = "Control HFSR VECTTBL: Indicates a fault has occurred because of a vector table read error on exception processing"]
    #[inline]
    pub fn write_control_hfsr_vecttbl(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_dfsr_external(&self) -> MemResult<bool> {
        todo!("read Control DFSR EXTERNAL reset value false")
    }
    #[doc = "Control DFSR EXTERNAL: Indicates a debug event generated because of the assertion of EDBGRQ"]
    #[inline]
    pub fn write_control_dfsr_external(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_dfsr_bkpt(&self) -> MemResult<bool> {
        todo!("read Control DFSR BKPT reset value false")
    }
    #[doc = "Control DFSR BKPT: Indicates a debug event generated by BKPT instruction execution or a breakpoint match in FPB"]
    #[inline]
    pub fn write_control_dfsr_bkpt(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_dfsr_halted(&self) -> MemResult<bool> {
        todo!("read Control DFSR HALTED reset value false")
    }
    #[doc = "Control DFSR HALTED: Indicates a debug event generated by C_HALT or C_STEP request or setting DEMCR.MON_STEP"]
    #[inline]
    pub fn write_control_dfsr_halted(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_control_mmfar(&self) -> MemResult<u32> {
        todo!("read Control MMFAR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "Control MMFAR: Shows the address of the memory location that caused an MMU fault"]
    #[inline]
    pub fn write_control_mmfar(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_control_stir_intid(&mut self, _value: u16) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_id_cpuid_partno(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_id_id_afr0(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_id_id_mmfr1(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_id_id_mmfr3(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_id_id_isar2_memhint_instrs(&self) -> MemResult<u8> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_aspen(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR ASPEN reset value false")
    }
    #[doc = "FPE FPCCR ASPEN: When this bit is set to 1, execution of a floating-point instruction sets the CONTROL.FPCA bit to 1"]
    #[inline]
    pub fn write_fpe_fpccr_aspen(&mut self, _value: bool) -> MemResult<()> {
        todo!("write FPE FPCCR ASPEN reset value false")
    }
    #[doc = "FPE FPCCR LSPEN: Enables lazy context save of FP state"]
    #[inline]
    pub fn read_fpe_fpccr_lspen(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR LSPEN reset value false")
    }
    #[doc = "FPE FPCCR LSPEN: Enables lazy context save of FP state"]
    #[inline]
    pub fn write_fpe_fpccr_lspen(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_monrdy(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR MONRDY reset value false")
    }
    #[doc = "FPE FPCCR MONRDY: Indicates whether the software executing when the processor allocated the FP stack frame was able to set the DebugMonitor exception to pending"]
    #[inline]
    pub fn write_fpe_fpccr_monrdy(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_bfrdy(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR BFRDY reset value false")
    }
    #[doc = "FPE FPCCR BFRDY: Indicates whether the software executing when the processor allocated the FP stack frame was able to set the BusFault exception to pending"]
    #[inline]
    pub fn write_fpe_fpccr_bfrdy(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_mmrdy(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR MMRDY reset value false")
    }
    #[doc = "FPE FPCCR MMRDY: Indicates whether the software executing when the processor allocated the FP stack frame was able to set the MemManage exception to pending"]
    #[inline]
    pub fn write_fpe_fpccr_mmrdy(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_hfrdy(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR HFRDY reset value false")
    }
    #[doc = "FPE FPCCR HFRDY: Indicates whether the software executing when the processor allocated the FP stack frame was able to set the HardFault exception to pending"]
    #[inline]
    pub fn write_fpe_fpccr_hfrdy(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_thread(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR THREAD reset value false")
    }
    #[doc = "FPE FPCCR THREAD: Indicates the processor mode when it allocated the FP stack frame"]
    #[inline]
    pub fn write_fpe_fpccr_thread(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_user(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR USER reset value false")
    }
    #[doc = "FPE FPCCR USER: Indicates the privilege level of the software executing when the processor allocated the FP stack frame"]
    #[inline]
    pub fn write_fpe_fpccr_user(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_fpe_fpccr_lspact(&self) -> MemResult<bool> {
        todo!("read FPE FPCCR LSPACT reset value false")
    }
    #[doc = "FPE FPCCR LSPACT: Indicates whether Lazy preservation of the FP state is active"]
    #[inline]
    pub fn write_fpe_fpccr_lspact(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_systick_stcsr_countflag(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_systick_stcsr_clksource(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_systick_stcsr_tickint(&self) -> MemResult<bool> {
        todo!("read SysTick STCSR TICKINT reset value false")
    }
    #[doc = "SysTick STCSR TICKINT: Indicates whether counting to 0 causes the status of the SysTick exception to change to pending"]
    #[inline]
    pub fn write_systick_stcsr_tickint(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_systick_stcsr_enable(&self) -> MemResult<bool> {
        todo!("read SysTick STCSR ENABLE reset value false")
    }
    #[doc = "SysTick STCSR ENABLE: Indicates the enabled status of the SysTick counter"]
    #[inline]
    pub fn write_systick_stcsr_enable(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_systick_strvr_reload(&self) -> MemResult<u32> {
        todo!("read SysTick STRVR RELOAD reset value 0x00 mask 0xffffff")
    }
    #[doc = "SysTick STRVR RELOAD: The value to load into the SYST_CVR register when the counter reaches 0"]
    #[inline]
    pub fn write_systick_strvr_reload(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_systick_stcvr_current(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_systick_stcr_noref(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_systick_stcr_skew(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_systick_stcr_tenms(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser0(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser1(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser2(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser3(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser4(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser5(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser6(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iser7(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icer0(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(0))
    }
    #[doc = "NVIC NVIC_ICER0: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer1(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(1))
    }
    #[doc = "NVIC NVIC_ICER1: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer2(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(2))
    }
    #[doc = "NVIC NVIC_ICER2: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer3(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(3))
    }
    #[doc = "NVIC NVIC_ICER3: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer4(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(4))
    }
    #[doc = "NVIC NVIC_ICER4: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer5(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(5))
    }
    #[doc = "NVIC NVIC_ICER5: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer6(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(6))
    }
    #[doc = "NVIC NVIC_ICER6: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_icer7(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(7))
    }
    #[doc = "NVIC NVIC_ICER7: Disables, or reads the enable state of a group of interrupts"]
    #[inline]
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr0(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(0))
    }
    #[doc = "NVIC NVIC_ISPR0: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr0(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr1(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(1))
    }
    #[doc = "NVIC NVIC_ISPR1: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr1(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr2(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(2))
    }
    #[doc = "NVIC NVIC_ISPR2: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr2(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr3(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(3))
    }
    #[doc = "NVIC NVIC_ISPR3: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr3(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr4(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(4))
    }
    #[doc = "NVIC NVIC_ISPR4: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr4(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr5(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(5))
    }
    #[doc = "NVIC NVIC_ISPR5: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr5(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr6(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(6))
    }
    #[doc = "NVIC NVIC_ISPR6: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr6(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_ispr7(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(7))
    }
    #[doc = "NVIC NVIC_ISPR7: For a group of interrupts, changes interrupt status to pending, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_ispr7(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr0(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(0))
    }
    #[doc = "NVIC NVIC_ICPR0: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr0(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr1(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(1))
    }
    #[doc = "NVIC NVIC_ICPR1: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr1(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr2(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(2))
    }
    #[doc = "NVIC NVIC_ICPR2: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr2(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr3(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(3))
    }
    #[doc = "NVIC NVIC_ICPR3: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr3(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr4(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(4))
    }
    #[doc = "NVIC NVIC_ICPR4: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr4(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr5(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(5))
    }
    #[doc = "NVIC NVIC_ICPR5: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr5(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr6(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(6))
    }
    #[doc = "NVIC NVIC_ICPR6: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr6(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_icpr7(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_pending(7))
    }
    #[doc = "NVIC NVIC_ICPR7: For a group of interrupts, clears the interrupt pending status, or shows the current pending\nstatus"]
    #[inline]
    pub fn write_nvic_nvic_icpr7(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr0(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(0))
    }
    #[doc = "NVIC NVIC_IABR0: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr0(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr1(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(1))
    }
    #[doc = "NVIC NVIC_IABR1: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr1(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr2(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(2))
    }
    #[doc = "NVIC NVIC_IABR2: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr2(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr3(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(3))
    }
    #[doc = "NVIC NVIC_IABR3: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr3(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr4(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(4))
    }
    #[doc = "NVIC NVIC_IABR4: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr4(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr5(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(5))
    }
    #[doc = "NVIC NVIC_IABR5: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr5(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr6(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(6))
    }
    #[doc = "NVIC NVIC_IABR6: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr6(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvic_nvic_iabr7(&self) -> MemResult<u32> {
        Ok(self.interrupts.nvic_enable(7))
    }
    #[doc = "NVIC NVIC_IABR7: For a group of 32 interrupts, shows whether each interrupt is active"]
    #[inline]
    pub fn write_nvic_nvic_iabr7(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_type_separate(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_mpu_mpu_ctrl_enable(&self) -> MemResult<bool> {
        todo!("read MPU MPU_CTRL ENABLE reset value false")
    }
    #[doc = "MPU MPU_CTRL ENABLE: Enables the MPU"]
    #[inline]
    pub fn write_mpu_mpu_ctrl_enable(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_ctrl_hfnmiena(&self) -> MemResult<bool> {
        todo!("read MPU MPU_CTRL HFNMIENA reset value false")
    }
    #[doc = "MPU MPU_CTRL HFNMIENA: When the ENABLE bit is set to 1, controls whether handlers executing with priority less than 0 access memory with the MPU enabled or with the MPU disabled"]
    #[inline]
    pub fn write_mpu_mpu_ctrl_hfnmiena(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_ctrl_privdefena(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rasr_b(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR B reset value false")
    }
    #[doc = "MPU MPU_RASR B: MPU Region Attribute field"]
    #[inline]
    pub fn write_mpu_mpu_rasr_b(&mut self, _value: bool) -> MemResult<()> {
        todo!("write MPU MPU_RASR B reset value false")
    }
    #[doc = "MPU MPU_RASR C: MPU Region Attribute field"]
    #[inline]
    pub fn read_mpu_mpu_rasr_c(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR C reset value false")
    }
    #[doc = "MPU MPU_RASR C: MPU Region Attribute field"]
    #[inline]
    pub fn write_mpu_mpu_rasr_c(&mut self, _value: bool) -> MemResult<()> {
        todo!("write MPU MPU_RASR C reset value false")
    }
    #[doc = "MPU MPU_RASR S: MPU Region Attribute field: Sharable"]
    #[inline]
    pub fn read_mpu_mpu_rasr_s(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR S reset value false")
    }
    #[doc = "MPU MPU_RASR S: MPU Region Attribute field: Sharable"]
    #[inline]
    pub fn write_mpu_mpu_rasr_s(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rasr_xn(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR XN reset value false")
    }
    #[doc = "MPU MPU_RASR XN: Execute Never"]
    #[inline]
    pub fn write_mpu_mpu_rasr_xn(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rbar_a1_valid(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RBAR_A1 VALID reset value false")
    }
    #[doc = "MPU MPU_RBAR_A1 VALID: On writes, indicates whether the region to update is specified by MPU_RNR.REGION, or by the REGION value specified in this write. When using the REGION value specified by this write, MPU_RNR.REGION is updated to this value"]
    #[inline]
    pub fn write_mpu_mpu_rbar_a1_valid(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rasr_a1_xn(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR_A1 XN reset value false")
    }
    #[doc = "MPU MPU_RASR_A1 XN: Execute Never"]
    #[inline]
    pub fn write_mpu_mpu_rasr_a1_xn(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rbar_a2_valid(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RBAR_A2 VALID reset value false")
    }
    #[doc = "MPU MPU_RBAR_A2 VALID: On writes, indicates whether the region to update is specified by MPU_RNR.REGION, or by the REGION value specified in this write. When using the REGION value specified by this write, MPU_RNR.REGION is updated to this value"]
    #[inline]
    pub fn write_mpu_mpu_rbar_a2_valid(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rasr_a2_xn(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR_A2 XN reset value false")
    }
    #[doc = "MPU MPU_RASR_A2 XN: Execute Never"]
    #[inline]
    pub fn write_mpu_mpu_rasr_a2_xn(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rbar_a3_valid(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RBAR_A3 VALID reset value false")
    }
    #[doc = "MPU MPU_RBAR_A3 VALID: On writes, indicates whether the region to update is specified by MPU_RNR.REGION, or by the REGION value specified in this write. When using the REGION value specified by this write, MPU_RNR.REGION is updated to this value"]
    #[inline]
    pub fn write_mpu_mpu_rbar_a3_valid(
        &mut self,
        _value: bool,
    ) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_mpu_mpu_rasr_a3_xn(&self) -> MemResult<bool> {
        todo!("read MPU MPU_RASR_A3 XN reset value false")
    }
    #[doc = "MPU MPU_RASR_A3 XN: Execute Never"]
    #[inline]
    pub fn write_mpu_mpu_rasr_a3_xn(&mut self, _value: bool) -> MemResult<()> {
        todo!("write MPU MPU_RASR_A3 XN reset value false")
    }
    #[doc = "POWER TASKS_CONSTLAT: Enable constant latency mode."]
    #[inline]
    pub fn write_power_tasks_constlat(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_power_tasks_lowpwr(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_power_events_pofwarn(&self) -> MemResult<u32> {
        todo ! ("read POWER EVENTS_POFWARN reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "POWER EVENTS_POFWARN: Power failure warning."]
    #[inline]
    pub fn write_power_events_pofwarn(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_powerclock_intenset_pofwarn(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenset_hfclkstarted(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenset_lfclkstarted(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenset_done(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenset_ctto(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenclr_pofwarn(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenclr_hfclkstarted(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenclr_lfclkstarted(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenclr_done(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_powerclock_intenclr_ctto(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_resetreas_resetpin(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_resetreas_dog(&self) -> MemResult<bool> {
        todo!("read POWER RESETREAS DOG reset value false")
    }
    #[doc = "POWER RESETREAS DOG: Reset from watchdog detected."]
    #[inline]
    pub fn write_power_resetreas_dog(&mut self, _value: bool) -> MemResult<()> {
        todo!("write POWER RESETREAS DOG reset value false")
    }
    #[doc = "POWER RESETREAS SREQ: Reset from AIRCR.SYSRESETREQ detected."]
    #[inline]
    pub fn read_power_resetreas_sreq(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_resetreas_lockup(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_resetreas_off(&self) -> MemResult<bool> {
        todo!("read POWER RESETREAS OFF reset value false")
    }
    #[doc = "POWER RESETREAS OFF: Reset from wake-up from OFF mode detected by the use of DETECT signal from GPIO."]
    #[inline]
    pub fn write_power_resetreas_off(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_power_resetreas_lpcomp(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_resetreas_dif(&self) -> MemResult<bool> {
        todo!("read POWER RESETREAS DIF reset value false")
    }
    #[doc = "POWER RESETREAS DIF: Reset from wake-up from OFF mode detected by entering into debug interface mode."]
    #[inline]
    pub fn write_power_resetreas_dif(&mut self, _value: bool) -> MemResult<()> {
        todo!("write POWER RESETREAS DIF reset value false")
    }
    #[doc = "POWER RAMSTATUS RAMBLOCK0: RAM block 0 status."]
    #[inline]
    pub fn read_power_ramstatus_ramblock0(&self) -> MemResult<bool> {
        Ok(self.ram_is_on(0))
    }
    #[doc = "POWER RAMSTATUS RAMBLOCK1: RAM block 1 status."]
    #[inline]
    pub fn read_power_ramstatus_ramblock1(&self) -> MemResult<bool> {
        Ok(self.ram_is_on(1))
    }
    #[doc = "POWER RAMSTATUS RAMBLOCK2: RAM block 2 status."]
    #[inline]
    pub fn read_power_ramstatus_ramblock2(&self) -> MemResult<bool> {
        Ok(self.ram_is_on(2))
    }
    #[doc = "POWER RAMSTATUS RAMBLOCK3: RAM block 3 status."]
    #[inline]
    pub fn read_power_ramstatus_ramblock3(&self) -> MemResult<bool> {
        Ok(self.ram_is_on(3))
    }
    ...
    #[inline]
    pub fn read_power_pofcon_pof(&self) -> MemResult<bool> {
        todo!("read POWER POFCON POF reset value false")
    }
    #[doc = "POWER POFCON POF: Power failure comparator enable."]
    #[inline]
    pub fn write_power_pofcon_pof(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_power_ramon_onram0(&self) -> MemResult<bool> {
        Ok(self.ram_is_keep_on(0))
    }
    #[doc = "POWER RAMON ONRAM0: RAM block 0 behaviour in ON mode."]
    #[inline]
    pub fn write_power_ramon_onram0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_keep_on(0, _value))
    }
    #[doc = "POWER RAMON ONRAM1: RAM block 1 behaviour in ON mode."]
    #[inline]
    pub fn read_power_ramon_onram1(&self) -> MemResult<bool> {
        Ok(self.ram_is_keep_on(1))
    }
    #[doc = "POWER RAMON ONRAM1: RAM block 1 behaviour in ON mode."]
    #[inline]
    pub fn write_power_ramon_onram1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_keep_on(1, _value))
    }
    #[doc = "POWER RAMON OFFRAM0: RAM block 0 behaviour in OFF mode."]
    #[inline]
    pub fn read_power_ramon_offram0(&self) -> MemResult<bool> {
        Ok(self.ram_is_retain_on(0))
    }
    #[doc = "POWER RAMON OFFRAM0: RAM block 0 behaviour in OFF mode."]
    #[inline]
    pub fn write_power_ramon_offram0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_retain_on(0, _value))
    }
    #[doc = "POWER RAMON OFFRAM1: RAM block 1 behaviour in OFF mode."]
    #[inline]
    pub fn read_power_ramon_offram1(&self) -> MemResult<bool> {
        Ok(self.ram_is_retain_on(1))
    }
    #[doc = "POWER RAMON OFFRAM1: RAM block 1 behaviour in OFF mode."]
    #[inline]
    pub fn write_power_ramon_offram1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_retain_on(1, _value))
    }
    #[doc = "POWER RESET RESET: Enable or disable pin reset in debug interface mode."]
    #[inline]
    pub fn read_power_reset_reset(&self) -> MemResult<bool> {
        todo!("read POWER RESET RESET reset value false")
    }
    #[doc = "POWER RESET RESET: Enable or disable pin reset in debug interface mode."]
    #[inline]
    pub fn write_power_reset_reset(&mut self, _value: bool) -> MemResult<()> {
        todo!("write POWER RESET RESET reset value false")
    }
    #[doc = "POWER RAMONB ONRAM2: RAM block 2 behaviour in ON mode."]
    #[inline]
    pub fn read_power_ramonb_onram2(&self) -> MemResult<bool> {
        Ok(self.ram_is_keep_on(2))
    }
    #[doc = "POWER RAMONB ONRAM2: RAM block 2 behaviour in ON mode."]
    #[inline]
    pub fn write_power_ramonb_onram2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_keep_on(2, _value))
    }
    #[doc = "POWER RAMONB ONRAM3: RAM block 3 behaviour in ON mode."]
    #[inline]
    pub fn read_power_ramonb_onram3(&self) -> MemResult<bool> {
        Ok(self.ram_is_keep_on(3))
    }
    #[doc = "POWER RAMONB ONRAM3: RAM block 3 behaviour in ON mode."]
    #[inline]
    pub fn write_power_ramonb_onram3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ram_set_keep_on(3, _value))
    }
    #[doc = "POWER RAMONB OFFRAM2: RAM block 2 behaviour in OFF mode."]
    #[inline]
    pub fn read_power_ramonb_offram2(&self) -> MemResult<bool> {
        Ok(self.ram_is_retain_on(2))
    }
    #[doc = "POWER RAMONB OFFRAM2: RAM block 2 behaviour in OFF mode."]
    #[inline]
    pub fn write_power_ramonb_offram2(
        ...
        Ok(self.ram_set_retain_on(2, _value))
    }
    #[doc = "POWER RAMONB OFFRAM3: RAM block 3 behaviour in OFF mode."]
    #[inline]
    pub fn read_power_ramonb_offram3(&self) -> MemResult<bool> {
        Ok(self.ram_is_retain_on(3))
    }
    #[doc = "POWER RAMONB OFFRAM3: RAM block 3 behaviour in OFF mode."]
    #[inline]
    pub fn write_power_ramonb_offram3(
        ...
        Ok(self.ram_set_retain_on(3, _value))
    }
    #[doc = "POWER DCDCEN DCDCEN: Enable DCDC converter."]
    #[inline]
    pub fn read_power_dcdcen_dcdcen(&self) -> MemResult<bool> {
        todo!("read POWER DCDCEN DCDCEN reset value false")
    }
    #[doc = "POWER DCDCEN DCDCEN: Enable DCDC converter."]
    #[inline]
    pub fn write_power_dcdcen_dcdcen(&mut self, _value: bool) -> MemResult<()> {
        todo!("write POWER DCDCEN DCDCEN reset value false")
    }
    #[doc = "POWER DCDCFORCE FORCEOFF: DCDC power-up force off."]
    #[inline]
    pub fn read_power_dcdcforce_forceoff(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_power_dcdcforce_forceon(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_clock_events_hfclkstarted(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_clock_events_lfclkstarted(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_clock_events_done(&self) -> MemResult<u32> {
        todo!("read CLOCK EVENTS_DONE reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "CLOCK EVENTS_DONE: Calibration of LFCLK RC oscillator completed."]
    #[inline]
    pub fn write_clock_events_done(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_clock_events_ctto(&self) -> MemResult<u32> {
        todo!("read CLOCK EVENTS_CTTO reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "CLOCK EVENTS_CTTO: Calibration timer timeout."]
    #[inline]
    pub fn write_clock_events_ctto(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_clock_lfclkstat_state(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_mpu_perr0_power_clock(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg1(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(1))
    }
    #[doc = "MPU PROTENSET0 PROTREG1: Protection enable for region 1."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg2(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(2))
    }
    #[doc = "MPU PROTENSET0 PROTREG2: Protection enable for region 2."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg3(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(3))
    }
    #[doc = "MPU PROTENSET0 PROTREG3: Protection enable for region 3."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg4(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(4))
    }
    #[doc = "MPU PROTENSET0 PROTREG4: Protection enable for region 4."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg5(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(5))
    }
    #[doc = "MPU PROTENSET0 PROTREG5: Protection enable for region 5."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg6(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(6))
    }
    #[doc = "MPU PROTENSET0 PROTREG6: Protection enable for region 6."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg7(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(7))
    }
    #[doc = "MPU PROTENSET0 PROTREG7: Protection enable for region 7."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg8(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(8))
    }
    #[doc = "MPU PROTENSET0 PROTREG8: Protection enable for region 8."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg9(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(9))
    }
    #[doc = "MPU PROTENSET0 PROTREG9: Protection enable for region 9."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg10(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(10))
    }
    #[doc = "MPU PROTENSET0 PROTREG10: Protection enable for region 10."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg11(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(11))
    }
    #[doc = "MPU PROTENSET0 PROTREG11: Protection enable for region 11."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg12(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(12))
    }
    #[doc = "MPU PROTENSET0 PROTREG12: Protection enable for region 12."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg13(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(13))
    }
    #[doc = "MPU PROTENSET0 PROTREG13: Protection enable for region 13."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg14(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(14))
    }
    #[doc = "MPU PROTENSET0 PROTREG14: Protection enable for region 14."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg15(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(15))
    }
    #[doc = "MPU PROTENSET0 PROTREG15: Protection enable for region 15."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg16(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(16))
    }
    #[doc = "MPU PROTENSET0 PROTREG16: Protection enable for region 16."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg17(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(17))
    }
    #[doc = "MPU PROTENSET0 PROTREG17: Protection enable for region 17."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg18(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(18))
    }
    #[doc = "MPU PROTENSET0 PROTREG18: Protection enable for region 18."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg19(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(19))
    }
    #[doc = "MPU PROTENSET0 PROTREG19: Protection enable for region 19."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg20(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(20))
    }
    #[doc = "MPU PROTENSET0 PROTREG20: Protection enable for region 20."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg21(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(21))
    }
    #[doc = "MPU PROTENSET0 PROTREG21: Protection enable for region 21."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg22(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(22))
    }
    #[doc = "MPU PROTENSET0 PROTREG22: Protection enable for region 22."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg23(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(23))
    }
    #[doc = "MPU PROTENSET0 PROTREG23: Protection enable for region 23."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg24(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(24))
    }
    #[doc = "MPU PROTENSET0 PROTREG24: Protection enable for region 24."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg25(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(25))
    }
    #[doc = "MPU PROTENSET0 PROTREG25: Protection enable for region 25."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg26(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(26))
    }
    #[doc = "MPU PROTENSET0 PROTREG26: Protection enable for region 26."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg27(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(27))
    }
    #[doc = "MPU PROTENSET0 PROTREG27: Protection enable for region 27."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg28(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(28))
    }
    #[doc = "MPU PROTENSET0 PROTREG28: Protection enable for region 28."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg29(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(29))
    }
    #[doc = "MPU PROTENSET0 PROTREG29: Protection enable for region 29."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg30(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(30))
    }
    #[doc = "MPU PROTENSET0 PROTREG30: Protection enable for region 30."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset0_protreg31(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(31))
    }
    #[doc = "MPU PROTENSET0 PROTREG31: Protection enable for region 31."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg32(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(32))
    }
    #[doc = "MPU PROTENSET1 PROTREG32: Protection enable for region 32."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg33(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(33))
    }
    #[doc = "MPU PROTENSET1 PROTREG33: Protection enable for region 33."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg34(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(34))
    }
    #[doc = "MPU PROTENSET1 PROTREG34: Protection enable for region 34."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg35(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(35))
    }
    #[doc = "MPU PROTENSET1 PROTREG35: Protection enable for region 35."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg36(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(36))
    }
    #[doc = "MPU PROTENSET1 PROTREG36: Protection enable for region 36."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg37(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(37))
    }
    #[doc = "MPU PROTENSET1 PROTREG37: Protection enable for region 37."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg38(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(38))
    }
    #[doc = "MPU PROTENSET1 PROTREG38: Protection enable for region 38."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg39(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(39))
    }
    #[doc = "MPU PROTENSET1 PROTREG39: Protection enable for region 39."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg40(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(40))
    }
    #[doc = "MPU PROTENSET1 PROTREG40: Protection enable for region 40."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg41(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(41))
    }
    #[doc = "MPU PROTENSET1 PROTREG41: Protection enable for region 41."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg42(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(42))
    }
    #[doc = "MPU PROTENSET1 PROTREG42: Protection enable for region 42."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg43(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(43))
    }
    #[doc = "MPU PROTENSET1 PROTREG43: Protection enable for region 43."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg44(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(44))
    }
    #[doc = "MPU PROTENSET1 PROTREG44: Protection enable for region 44."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg45(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(45))
    }
    #[doc = "MPU PROTENSET1 PROTREG45: Protection enable for region 45."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg46(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(46))
    }
    #[doc = "MPU PROTENSET1 PROTREG46: Protection enable for region 46."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg47(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(47))
    }
    #[doc = "MPU PROTENSET1 PROTREG47: Protection enable for region 47."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg48(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(48))
    }
    #[doc = "MPU PROTENSET1 PROTREG48: Protection enable for region 48."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg49(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(49))
    }
    #[doc = "MPU PROTENSET1 PROTREG49: Protection enable for region 49."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg50(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(50))
    }
    #[doc = "MPU PROTENSET1 PROTREG50: Protection enable for region 50."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg51(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(51))
    }
    #[doc = "MPU PROTENSET1 PROTREG51: Protection enable for region 51."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg52(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(52))
    }
    #[doc = "MPU PROTENSET1 PROTREG52: Protection enable for region 52."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg53(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(53))
    }
    #[doc = "MPU PROTENSET1 PROTREG53: Protection enable for region 53."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg54(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(54))
    }
    #[doc = "MPU PROTENSET1 PROTREG54: Protection enable for region 54."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg55(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(55))
    }
    #[doc = "MPU PROTENSET1 PROTREG55: Protection enable for region 55."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg56(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(56))
    }
    #[doc = "MPU PROTENSET1 PROTREG56: Protection enable for region 56."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg57(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(57))
    }
    #[doc = "MPU PROTENSET1 PROTREG57: Protection enable for region 57."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg58(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(58))
    }
    #[doc = "MPU PROTENSET1 PROTREG58: Protection enable for region 58."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg59(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(59))
    }
    #[doc = "MPU PROTENSET1 PROTREG59: Protection enable for region 59."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg60(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(60))
    }
    #[doc = "MPU PROTENSET1 PROTREG60: Protection enable for region 60."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg61(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(61))
    }
    #[doc = "MPU PROTENSET1 PROTREG61: Protection enable for region 61."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg62(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(62))
    }
    #[doc = "MPU PROTENSET1 PROTREG62: Protection enable for region 62."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_protenset1_protreg63(&self) -> MemResult<bool> {
        Ok(self.mpu_is_protected(63))
    }
    #[doc = "MPU PROTENSET1 PROTREG63: Protection enable for region 63."]
    #[inline]
    ...
    #[inline]
    pub fn read_mpu_disableindebug_disableindebug(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn write_radio_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
        todo!("write RADIO TASKS_STOP reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO TASKS_DISABLE: Disable radio."]
    #[inline]
    pub fn write_radio_tasks_disable(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_events_ready(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "RADIO EVENTS_READY: Ready event."]
    #[inline]
    pub fn write_radio_events_ready(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_radio_events_devmatch(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_radio_events_devmiss(&self) -> MemResult<u32> {
        todo ! ("read RADIO EVENTS_DEVMISS reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO EVENTS_DEVMISS: No device address match occurred on the last received packet."]
    #[inline]
    pub fn write_radio_events_devmiss(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_events_rssiend(&self) -> MemResult<u32> {
        todo ! ("read RADIO EVENTS_RSSIEND reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO EVENTS_RSSIEND: Sampling of the receive signal strength complete. A new RSSI sample is ready for readout at the RSSISAMPLE register."]
    #[inline]
    pub fn write_radio_events_rssiend(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_events_bcmatch(&self) -> MemResult<u32> {
        todo ! ("read RADIO EVENTS_BCMATCH reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO EVENTS_BCMATCH: Bit counter reached bit count value specified in BCC register."]
    #[inline]
    pub fn write_radio_events_bcmatch(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_shorts_ready_start(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_end_disable(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_disabled_txen(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_disabled_rxen(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_address_rssistart(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_end_start(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_address_bcstart(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_shorts_disabled_rssistop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_address(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_payload(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_end(&self) -> MemResult<bool> {
        todo!("read RADIO INTENSET END reset value false")
    }
    #[doc = "RADIO INTENSET END: Enable interrupt on END event."]
    #[inline]
    pub fn write_radio_intenset_end(&mut self, _value: bool) -> MemResult<()> {
        todo!("write RADIO INTENSET END reset value false")
    }
    #[doc = "RADIO INTENSET DISABLED: Enable interrupt on DISABLED event."]
    #[inline]
    pub fn read_radio_intenset_disabled(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_devmatch(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_devmiss(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_rssiend(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenset_bcmatch(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_address(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_payload(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_end(&self) -> MemResult<bool> {
        todo!("read RADIO INTENCLR END reset value false")
    }
    #[doc = "RADIO INTENCLR END: Disable interrupt on END event."]
    #[inline]
    pub fn write_radio_intenclr_end(&mut self, _value: bool) -> MemResult<()> {
        todo!("write RADIO INTENCLR END reset value false")
    }
    #[doc = "RADIO INTENCLR DISABLED: Disable interrupt on DISABLED event."]
    #[inline]
    pub fn read_radio_intenclr_disabled(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_devmatch(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_devmiss(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_rssiend(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_intenclr_bcmatch(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_crcstatus_crcstatus(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_rxcrc_rxcrc(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_radio_packetptr(&self) -> MemResult<u32> {
        todo!("read RADIO PACKETPTR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO PACKETPTR: Packet pointer. Decision point: START task."]
    #[inline]
    pub fn write_radio_packetptr(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_pcnf0_s0len(&self) -> MemResult<bool> {
        todo!("read RADIO PCNF0 S0LEN reset value false")
    }
    #[doc = "RADIO PCNF0 S0LEN: Length of S0 field in number of bytes. Decision point: START task."]
    #[inline]
    pub fn write_radio_pcnf0_s0len(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_base1(&self) -> MemResult<u32> {
        todo!("read RADIO BASE1 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO BASE1: Radio base address 1. Decision point: START task."]
    #[inline]
    pub fn write_radio_base1(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_rxaddresses_addr0(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(0))
    }
    #[doc = "RADIO RXADDRESSES ADDR0: Enable reception on logical address 0. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr0(
        ...
        Ok(self.radio_set_recv_on_ap(0, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR1: Enable reception on logical address 1. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr1(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(1))
    }
    #[doc = "RADIO RXADDRESSES ADDR1: Enable reception on logical address 1. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr1(
        ...
        Ok(self.radio_set_recv_on_ap(1, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR2: Enable reception on logical address 2. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr2(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(2))
    }
    #[doc = "RADIO RXADDRESSES ADDR2: Enable reception on logical address 2. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr2(
        ...
        Ok(self.radio_set_recv_on_ap(2, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR3: Enable reception on logical address 3. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr3(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(3))
    }
    #[doc = "RADIO RXADDRESSES ADDR3: Enable reception on logical address 3. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr3(
        ...
        Ok(self.radio_set_recv_on_ap(3, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR4: Enable reception on logical address 4. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr4(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(4))
    }
    #[doc = "RADIO RXADDRESSES ADDR4: Enable reception on logical address 4. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr4(
        ...
        Ok(self.radio_set_recv_on_ap(4, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR5: Enable reception on logical address 5. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr5(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(5))
    }
    #[doc = "RADIO RXADDRESSES ADDR5: Enable reception on logical address 5. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr5(
        ...
        Ok(self.radio_set_recv_on_ap(5, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR6: Enable reception on logical address 6. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr6(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(6))
    }
    #[doc = "RADIO RXADDRESSES ADDR6: Enable reception on logical address 6. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr6(
        ...
        Ok(self.radio_set_recv_on_ap(6, _value))
    }
    #[doc = "RADIO RXADDRESSES ADDR7: Enable reception on logical address 7. Decision point: START task."]
    #[inline]
    pub fn read_radio_rxaddresses_addr7(&self) -> MemResult<bool> {
        Ok(self.radio_is_recv_on_ap(7))
    }
    #[doc = "RADIO RXADDRESSES ADDR7: Enable reception on logical address 7. Decision point: START task."]
    #[inline]
    pub fn write_radio_rxaddresses_addr7(
        ...
        Ok(self.radio_set_recv_on_ap(7, _value))
    }
    ...
    #[inline]
    pub fn read_radio_crccnf_skipaddr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_crcpoly_crcpoly(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_radio_crcinit_crcinit(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_radio_test_constcarrier(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_radio_test_plllock(&self) -> MemResult<bool> {
        todo!("read RADIO TEST PLLLOCK reset value false")
    }
    #[doc = "RADIO TEST PLLLOCK: PLL lock. Decision point: TXEN or RXEN task."]
    #[inline]
    pub fn write_radio_test_plllock(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_radio_dapn_dap(&self, _dim: usize) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_radio_dacnf_ena0(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(0))
    }
    #[doc = "RADIO DACNF ENA0: Enable or disable device address matching using device address 0."]
    #[inline]
    pub fn write_radio_dacnf_ena0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(0, _value))
    }
    #[doc = "RADIO DACNF ENA1: Enable or disable device address matching using device address 1."]
    #[inline]
    pub fn read_radio_dacnf_ena1(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(1))
    }
    #[doc = "RADIO DACNF ENA1: Enable or disable device address matching using device address 1."]
    #[inline]
    pub fn write_radio_dacnf_ena1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(1, _value))
    }
    #[doc = "RADIO DACNF ENA2: Enable or disable device address matching using device address 2."]
    #[inline]
    pub fn read_radio_dacnf_ena2(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(2))
    }
    #[doc = "RADIO DACNF ENA2: Enable or disable device address matching using device address 2."]
    #[inline]
    pub fn write_radio_dacnf_ena2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(2, _value))
    }
    #[doc = "RADIO DACNF ENA3: Enable or disable device address matching using device address 3."]
    #[inline]
    pub fn read_radio_dacnf_ena3(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(3))
    }
    #[doc = "RADIO DACNF ENA3: Enable or disable device address matching using device address 3."]
    #[inline]
    pub fn write_radio_dacnf_ena3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(3, _value))
    }
    #[doc = "RADIO DACNF ENA4: Enable or disable device address matching using device address 4."]
    #[inline]
    pub fn read_radio_dacnf_ena4(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(4))
    }
    #[doc = "RADIO DACNF ENA4: Enable or disable device address matching using device address 4."]
    #[inline]
    pub fn write_radio_dacnf_ena4(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(4, _value))
    }
    #[doc = "RADIO DACNF ENA5: Enable or disable device address matching using device address 5."]
    #[inline]
    pub fn read_radio_dacnf_ena5(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(5))
    }
    #[doc = "RADIO DACNF ENA5: Enable or disable device address matching using device address 5."]
    #[inline]
    pub fn write_radio_dacnf_ena5(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(5, _value))
    }
    #[doc = "RADIO DACNF ENA6: Enable or disable device address matching using device address 6."]
    #[inline]
    pub fn read_radio_dacnf_ena6(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(6))
    }
    #[doc = "RADIO DACNF ENA6: Enable or disable device address matching using device address 6."]
    #[inline]
    pub fn write_radio_dacnf_ena6(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(6, _value))
    }
    #[doc = "RADIO DACNF ENA7: Enable or disable device address matching using device address 7."]
    #[inline]
    pub fn read_radio_dacnf_ena7(&self) -> MemResult<bool> {
        Ok(self.radio_is_ena(7))
    }
    #[doc = "RADIO DACNF ENA7: Enable or disable device address matching using device address 7."]
    #[inline]
    pub fn write_radio_dacnf_ena7(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_ena(7, _value))
    }
    #[doc = "RADIO DACNF TXADD0: TxAdd for device address 0."]
    #[inline]
    pub fn read_radio_dacnf_txadd0(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(0))
    }
    #[doc = "RADIO DACNF TXADD0: TxAdd for device address 0."]
    #[inline]
    pub fn write_radio_dacnf_txadd0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(0, _value))
    }
    #[doc = "RADIO DACNF TXADD1: TxAdd for device address 1."]
    #[inline]
    pub fn read_radio_dacnf_txadd1(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(1))
    }
    #[doc = "RADIO DACNF TXADD1: TxAdd for device address 1."]
    #[inline]
    pub fn write_radio_dacnf_txadd1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(1, _value))
    }
    #[doc = "RADIO DACNF TXADD2: TxAdd for device address 2."]
    #[inline]
    pub fn read_radio_dacnf_txadd2(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(2))
    }
    #[doc = "RADIO DACNF TXADD2: TxAdd for device address 2."]
    #[inline]
    pub fn write_radio_dacnf_txadd2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(2, _value))
    }
    #[doc = "RADIO DACNF TXADD3: TxAdd for device address 3."]
    #[inline]
    pub fn read_radio_dacnf_txadd3(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(3))
    }
    #[doc = "RADIO DACNF TXADD3: TxAdd for device address 3."]
    #[inline]
    pub fn write_radio_dacnf_txadd3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(3, _value))
    }
    #[doc = "RADIO DACNF TXADD4: TxAdd for device address 4."]
    #[inline]
    pub fn read_radio_dacnf_txadd4(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(4))
    }
    #[doc = "RADIO DACNF TXADD4: TxAdd for device address 4."]
    #[inline]
    pub fn write_radio_dacnf_txadd4(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(4, _value))
    }
    #[doc = "RADIO DACNF TXADD5: TxAdd for device address 5."]
    #[inline]
    pub fn read_radio_dacnf_txadd5(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(5))
    }
    #[doc = "RADIO DACNF TXADD5: TxAdd for device address 5."]
    #[inline]
    pub fn write_radio_dacnf_txadd5(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(5, _value))
    }
    #[doc = "RADIO DACNF TXADD6: TxAdd for device address 6."]
    #[inline]
    pub fn read_radio_dacnf_txadd6(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(6))
    }
    #[doc = "RADIO DACNF TXADD6: TxAdd for device address 6."]
    #[inline]
    pub fn write_radio_dacnf_txadd6(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(6, _value))
    }
    #[doc = "RADIO DACNF TXADD7: TxAdd for device address 7."]
    #[inline]
    pub fn read_radio_dacnf_txadd7(&self) -> MemResult<bool> {
        Ok(self.radio_is_txadd(7))
    }
    #[doc = "RADIO DACNF TXADD7: TxAdd for device address 7."]
    #[inline]
    pub fn write_radio_dacnf_txadd7(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.radio_set_txadd(7, _value))
    }
    #[doc = "RADIO OVERRIDE0: Trim value override register 0."]
    #[inline]
    pub fn read_radio_override0(&self) -> MemResult<u32> {
        todo!("read RADIO OVERRIDE0 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE0: Trim value override register 0."]
    #[inline]
    pub fn write_radio_override0(&mut self, _value: u32) -> MemResult<()> {
        todo!("write RADIO OVERRIDE0 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE1: Trim value override register 1."]
    #[inline]
    pub fn read_radio_override1(&self) -> MemResult<u32> {
        todo!("read RADIO OVERRIDE1 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE1: Trim value override register 1."]
    #[inline]
    pub fn write_radio_override1(&mut self, _value: u32) -> MemResult<()> {
        todo!("write RADIO OVERRIDE1 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE2: Trim value override register 2."]
    #[inline]
    pub fn read_radio_override2(&self) -> MemResult<u32> {
        todo!("read RADIO OVERRIDE2 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE2: Trim value override register 2."]
    #[inline]
    pub fn write_radio_override2(&mut self, _value: u32) -> MemResult<()> {
        todo!("write RADIO OVERRIDE2 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE3: Trim value override register 3."]
    #[inline]
    pub fn read_radio_override3(&self) -> MemResult<u32> {
        todo!("read RADIO OVERRIDE3 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE3: Trim value override register 3."]
    #[inline]
    pub fn write_radio_override3(&mut self, _value: u32) -> MemResult<()> {
        todo!("write RADIO OVERRIDE3 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RADIO OVERRIDE4 OVERRIDE4: Trim value override 4."]
    #[inline]
    pub fn read_radio_override4_override4(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_radio_override4_enable(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn write_uart0_tasks_starttx(&mut self, _value: u32) -> MemResult<()> {
        todo ! ("write UART0 TASKS_STARTTX reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "UART0 TASKS_STOPTX: Stop UART transmitter."]
    #[inline]
    pub fn write_uart0_tasks_stoptx(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_uart0_events_rxdrdy(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "UART0 EVENTS_TXDRDY: Data sent from TXD."]
    #[inline]
    pub fn write_uart0_events_txdrdy(&mut self, _value: u32) -> MemResult<()> {
        todo ! ("write UART0 EVENTS_TXDRDY reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "UART0 EVENTS_ERROR: Error detected."]
    #[inline]
    pub fn read_uart0_events_error(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "UART0 EVENTS_ERROR: Error detected."]
    #[inline]
    pub fn write_uart0_events_error(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_uart0_events_rxto(&self) -> MemResult<u32> {
        todo!("read UART0 EVENTS_RXTO reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "UART0 EVENTS_RXTO: Receiver timeout."]
    #[inline]
    pub fn write_uart0_events_rxto(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_uart0_shorts_cts_startrx(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_shorts_ncts_stoprx(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_intenset_txdrdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_intenset_error(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_intenclr_txdrdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_intenclr_error(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_intenclr_rxto(&self) -> MemResult<bool> {
        todo!("read UART0 INTENCLR RXTO reset value false")
    }
    #[doc = "UART0 INTENCLR RXTO: Disable interrupt on RXTO event."]
    #[inline]
    pub fn write_uart0_intenclr_rxto(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_uart0_errorsrc_overrun(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_errorsrc_parity(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_errorsrc_framing(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_errorsrc_break(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_uart0_pselrts(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "UART0 PSELRXD: Pin select for RXD."]
    #[inline]
    pub fn write_uart0_pselrxd(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_uart0_power_power(&self) -> MemResult<bool> {
        todo!("read UART0 POWER POWER reset value false")
    }
    #[doc = "UART0 POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_uart0_power_power(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spi0twi0_events_ready(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_stopped(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_txdsent(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_error(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_bb(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenset_suspended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_stopped(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_txdsent(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_error(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_bb(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0twi0_intenclr_suspended(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spi0_pselmiso(&self) -> MemResult<u32> {
        todo ! ("read SPI0 PSELMISO, SPI0 PSELMISO reset value 0xffffffff mask 0xffffffffffffffff")
    }
    #[doc = "SPI0 PSELMISO: Pin select for MISO.\n\nSPI0 PSELMISO: Pin select for MISO."]
    #[inline]
    pub fn write_spi0_pselmiso(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spi0_config_order(&self) -> MemResult<bool> {
        todo!("read SPI0 CONFIG ORDER, SPI0 CONFIG ORDER reset value false")
    }
    #[doc = "SPI0 CONFIG ORDER: Bit order.\n\nSPI0 CONFIG ORDER: Bit order."]
    #[inline]
    pub fn write_spi0_config_order(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spi0_config_cpha(&self) -> MemResult<bool> {
        todo!("read SPI0 CONFIG CPHA, SPI0 CONFIG CPHA reset value false")
    }
    #[doc = "SPI0 CONFIG CPHA: Serial clock (SCK) phase.\n\nSPI0 CONFIG CPHA: Serial clock (SCK) phase."]
    #[inline]
    pub fn write_spi0_config_cpha(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spi0_config_cpol(&self) -> MemResult<bool> {
        todo!("read SPI0 CONFIG CPOL, SPI0 CONFIG CPOL reset value false")
    }
    #[doc = "SPI0 CONFIG CPOL: Serial clock (SCK) polarity.\n\nSPI0 CONFIG CPOL: Serial clock (SCK) polarity."]
    #[inline]
    pub fn write_spi0_config_cpol(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spi0twi0_power_power(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn write_twi0_tasks_startrx(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_twi0_tasks_starttx(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_twi0_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_twi0_tasks_suspend(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_twi0_tasks_resume(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_twi0_events_stopped(&self) -> MemResult<u32> {
        todo ! ("read TWI0 EVENTS_STOPPED, TWI0 EVENTS_STOPPED reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "TWI0 EVENTS_STOPPED: Two-wire stopped.\n\nTWI0 EVENTS_STOPPED: Two-wire stopped."]
    #[inline]
    pub fn write_twi0_events_stopped(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_twi0_events_txdsent(&self) -> MemResult<u32> {
        todo ! ("read TWI0 EVENTS_TXDSENT, TWI0 EVENTS_TXDSENT reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "TWI0 EVENTS_TXDSENT: Two-wire finished sending last TXD byte.\n\nTWI0 EVENTS_TXDSENT: Two-wire finished sending last TXD byte."]
    #[inline]
    pub fn write_twi0_events_txdsent(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_twi0_events_error(&self) -> MemResult<u32> {
        todo ! ("read TWI0 EVENTS_ERROR, TWI0 EVENTS_ERROR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "TWI0 EVENTS_ERROR: Two-wire error detected.\n\nTWI0 EVENTS_ERROR: Two-wire error detected."]
    #[inline]
    pub fn write_twi0_events_error(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_twi0_events_bb(&self) -> MemResult<u32> {
        todo ! ("read TWI0 EVENTS_BB, TWI0 EVENTS_BB reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "TWI0 EVENTS_BB: Two-wire byte boundary.\n\nTWI0 EVENTS_BB: Two-wire byte boundary."]
    #[inline]
    pub fn write_twi0_events_bb(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_twi0_events_suspended(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_twi0_shorts_bb_suspend(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_twi0_shorts_bb_stop(&self) -> MemResult<bool> {
        todo!("read TWI0 SHORTS BB_STOP, TWI0 SHORTS BB_STOP reset value false")
    }
    #[doc = "TWI0 SHORTS BB_STOP: Shortcut between BB event and the STOP task.\n\nTWI0 SHORTS BB_STOP: Shortcut between BB event and the STOP task."]
    #[inline]
    pub fn write_twi0_shorts_bb_stop(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_twi0_errorsrc_overrun(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_twi0_errorsrc_anack(&self) -> MemResult<bool> {
        todo!("read TWI0 ERRORSRC ANACK, TWI0 ERRORSRC ANACK reset value false")
    }
    #[doc = "TWI0 ERRORSRC ANACK: NACK received after sending the address.\n\nTWI0 ERRORSRC ANACK: NACK received after sending the address."]
    #[inline]
    pub fn write_twi0_errorsrc_anack(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_twi0_errorsrc_dnack(&self) -> MemResult<bool> {
        todo!("read TWI0 ERRORSRC DNACK, TWI0 ERRORSRC DNACK reset value false")
    }
    #[doc = "TWI0 ERRORSRC DNACK: NACK received after sending a data byte.\n\nTWI0 ERRORSRC DNACK: NACK received after sending a data byte."]
    #[inline]
    pub fn write_twi0_errorsrc_dnack(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn write_spis1_tasks_acquire(&mut self, _value: u32) -> MemResult<()> {
        todo ! ("write SPIS1 TASKS_ACQUIRE reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "SPIS1 TASKS_RELEASE: Release SPI semaphore."]
    #[inline]
    pub fn write_spis1_tasks_release(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[doc = "SPIS1 EVENTS_ENDRX: End of RXD buffer reached"]
    #[inline]
    pub fn write_spis1_events_endrx(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_spis1_events_acquired(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_spis1_shorts_end_acquire(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_intenset_end(&self) -> MemResult<bool> {
        todo!("read SPIS1 INTENSET END reset value false")
    }
    #[doc = "SPIS1 INTENSET END: Enable interrupt on END event."]
    #[inline]
    pub fn write_spis1_intenset_end(&mut self, _value: bool) -> MemResult<()> {
        todo!("write SPIS1 INTENSET END reset value false")
    }
    #[doc = "SPIS1 INTENSET ENDRX: enable interrupt on ENDRX event."]
    #[inline]
    pub fn read_spis1_intenset_endrx(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_intenset_acquired(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_intenclr_end(&self) -> MemResult<bool> {
        todo!("read SPIS1 INTENCLR END reset value false")
    }
    #[doc = "SPIS1 INTENCLR END: Disable interrupt on END event."]
    #[inline]
    pub fn write_spis1_intenclr_end(&mut self, _value: bool) -> MemResult<()> {
        todo!("write SPIS1 INTENCLR END reset value false")
    }
    #[doc = "SPIS1 INTENCLR ENDRX: Disable interrupt on ENDRX event."]
    #[inline]
    pub fn read_spis1_intenclr_endrx(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_intenclr_acquired(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_status_overread(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_status_overflow(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_spis1_pselsck(&self) -> MemResult<u32> {
        todo!(
    ...
    #[inline]
    pub fn read_spis1_txdptr(&self) -> MemResult<u32> {
        todo!("read SPIS1 TXDPTR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "SPIS1 TXDPTR: TX data pointer."]
    #[inline]
    pub fn write_spis1_txdptr(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spis1_config_order(&self) -> MemResult<bool> {
        todo!("read SPIS1 CONFIG ORDER reset value false")
    }
    #[doc = "SPIS1 CONFIG ORDER: Bit order."]
    #[inline]
    pub fn write_spis1_config_order(&mut self, _value: bool) -> MemResult<()> {
        todo!("write SPIS1 CONFIG ORDER reset value false")
    }
    #[doc = "SPIS1 CONFIG CPHA: Serial clock (SCK) phase."]
    #[inline]
    pub fn read_spis1_config_cpha(&self) -> MemResult<bool> {
        todo!("read SPIS1 CONFIG CPHA reset value false")
    }
    #[doc = "SPIS1 CONFIG CPHA: Serial clock (SCK) phase."]
    #[inline]
    pub fn write_spis1_config_cpha(&mut self, _value: bool) -> MemResult<()> {
        todo!("write SPIS1 CONFIG CPHA reset value false")
    }
    #[doc = "SPIS1 CONFIG CPOL: Serial clock (SCK) polarity."]
    #[inline]
    pub fn read_spis1_config_cpol(&self) -> MemResult<bool> {
        todo!("read SPIS1 CONFIG CPOL reset value false")
    }
    #[doc = "SPIS1 CONFIG CPOL: Serial clock (SCK) polarity."]
    #[inline]
    pub fn write_spis1_config_cpol(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_spis1_power_power(&self) -> MemResult<bool> {
        todo!("read SPIS1 POWER POWER reset value false")
    }
    #[doc = "SPIS1 POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_spis1_power_power(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_gpiote_events_inn(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_gpiote_events_port(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "GPIOTE EVENTS_PORT: Event generated from multiple pins."]
    #[inline]
    pub fn write_gpiote_events_port(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_gpiote_confign_outinit(&self, _dim: usize) -> MemResult<bool> {
    ...
    #[inline]
    pub fn write_timer0_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_timer0_tasks_count(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_timer0_tasks_clear(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_timer0_events_comparen(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare0_clear(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare1_clear(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare2_clear(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare3_clear(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare0_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare1_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare2_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_shorts_compare3_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenset_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenset_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenset_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenset_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenclr_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenclr_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenclr_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_intenclr_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_timer0_mode_mode(&self) -> MemResult<bool> {
        todo ! ("read TIMER0 MODE MODE, TIMER0 MODE MODE, TIMER0 MODE MODE reset value false")
    }
    #[doc = "TIMER0 MODE MODE: Select Normal or Counter mode.\n\nTIMER0 MODE MODE: Select Normal or Counter mode.\n\nTIMER0 MODE MODE: Select Normal or Counter mode."]
    #[inline]
    pub fn write_timer0_mode_mode(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_timer0_ccn(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_timer0_power_power(&self) -> MemResult<bool> {
        todo ! ("read TIMER0 POWER POWER, TIMER0 POWER POWER, TIMER0 POWER POWER reset value false")
    }
    #[doc = "TIMER0 POWER POWER: Peripheral power control.\n\nTIMER0 POWER POWER: Peripheral power control.\n\nTIMER0 POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_timer0_power_power(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_rtc0_tasks_start(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_rtc0_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_rtc0_tasks_clear(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_events_tick(&self) -> MemResult<u32> {
        todo ! ("read RTC0 EVENTS_TICK, RTC0 EVENTS_TICK reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RTC0 EVENTS_TICK: Event on COUNTER increment.\n\nRTC0 EVENTS_TICK: Event on COUNTER increment."]
    #[inline]
    pub fn write_rtc0_events_tick(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_events_ovrflw(&self) -> MemResult<u32> {
        todo ! ("read RTC0 EVENTS_OVRFLW, RTC0 EVENTS_OVRFLW reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RTC0 EVENTS_OVRFLW: Event on COUNTER overflow.\n\nRTC0 EVENTS_OVRFLW: Event on COUNTER overflow."]
    #[inline]
    pub fn write_rtc0_events_ovrflw(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_events_comparen(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_rtc0_intenset_tick(&self) -> MemResult<bool> {
        todo!("read RTC0 INTENSET TICK, RTC0 INTENSET TICK reset value false")
    }
    #[doc = "RTC0 INTENSET TICK: Enable interrupt on TICK event.\n\nRTC0 INTENSET TICK: Enable interrupt on TICK event."]
    #[inline]
    pub fn write_rtc0_intenset_tick(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_intenset_ovrflw(&self) -> MemResult<bool> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_intenset_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenset_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenset_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenset_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenclr_tick(&self) -> MemResult<bool> {
        todo!("read RTC0 INTENCLR TICK, RTC0 INTENCLR TICK reset value false")
    }
    #[doc = "RTC0 INTENCLR TICK: Disable interrupt on TICK event.\n\nRTC0 INTENCLR TICK: Disable interrupt on TICK event."]
    #[inline]
    pub fn write_rtc0_intenclr_tick(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_intenclr_ovrflw(&self) -> MemResult<bool> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_intenclr_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenclr_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenclr_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_intenclr_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evten_tick(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN TICK, RTC0 EVTEN TICK reset value false")
    }
    #[doc = "RTC0 EVTEN TICK: TICK event enable.\n\nRTC0 EVTEN TICK: TICK event enable."]
    #[inline]
    pub fn write_rtc0_evten_tick(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_evten_ovrflw(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN OVRFLW, RTC0 EVTEN OVRFLW reset value false")
    }
    #[doc = "RTC0 EVTEN OVRFLW: OVRFLW event enable.\n\nRTC0 EVTEN OVRFLW: OVRFLW event enable."]
    #[inline]
    pub fn write_rtc0_evten_ovrflw(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_evten_compare0(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN COMPARE0, RTC0 EVTEN COMPARE0 reset value false")
    }
    #[doc = "RTC0 EVTEN COMPARE0: COMPARE[0] event enable.\n\nRTC0 EVTEN COMPARE0: COMPARE[0] event enable."]
    #[inline]
    pub fn write_rtc0_evten_compare0(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evten_compare1(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN COMPARE1, RTC0 EVTEN COMPARE1 reset value false")
    }
    #[doc = "RTC0 EVTEN COMPARE1: COMPARE[1] event enable.\n\nRTC0 EVTEN COMPARE1: COMPARE[1] event enable."]
    #[inline]
    pub fn write_rtc0_evten_compare1(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evten_compare2(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN COMPARE2, RTC0 EVTEN COMPARE2 reset value false")
    }
    #[doc = "RTC0 EVTEN COMPARE2: COMPARE[2] event enable.\n\nRTC0 EVTEN COMPARE2: COMPARE[2] event enable."]
    #[inline]
    pub fn write_rtc0_evten_compare2(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evten_compare3(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTEN COMPARE3, RTC0 EVTEN COMPARE3 reset value false")
    }
    #[doc = "RTC0 EVTEN COMPARE3: COMPARE[3] event enable.\n\nRTC0 EVTEN COMPARE3: COMPARE[3] event enable."]
    #[inline]
    pub fn write_rtc0_evten_compare3(&mut self, _value: bool) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evtenset_tick(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTENSET TICK, RTC0 EVTENSET TICK reset value false")
    }
    #[doc = "RTC0 EVTENSET TICK: Enable routing to PPI of TICK event.\n\nRTC0 EVTENSET TICK: Enable routing to PPI of TICK event."]
    #[inline]
    pub fn write_rtc0_evtenset_tick(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_evtenset_ovrflw(&self) -> MemResult<bool> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evtenset_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenset_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenset_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenset_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_tick(&self) -> MemResult<bool> {
        todo!("read RTC0 EVTENCLR TICK, RTC0 EVTENCLR TICK reset value false")
    }
    #[doc = "RTC0 EVTENCLR TICK: Disable routing to PPI of TICK event.\n\nRTC0 EVTENCLR TICK: Disable routing to PPI of TICK event."]
    #[inline]
    pub fn write_rtc0_evtenclr_tick(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_ovrflw(&self) -> MemResult<bool> {
        todo!(
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_compare0(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_compare1(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_compare2(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_evtenclr_compare3(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rtc0_counter_counter(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_rtc0_prescaler_prescaler(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_rtc0_ccn_compare(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_temp_events_datardy(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "TEMP EVENTS_DATARDY: Temperature measurement complete, data ready event."]
    #[inline]
    pub fn write_temp_events_datardy(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_temp_intenset_datardy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_temp_intenclr_datardy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rng_events_valrdy(&self) -> MemResult<u32> {
        todo!("read RNG EVENTS_VALRDY reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "RNG EVENTS_VALRDY: New random number generated and written to VALUE register."]
    #[inline]
    pub fn write_rng_events_valrdy(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_rng_shorts_valrdy_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_rng_power_power(&self) -> MemResult<bool> {
        todo!("read RNG POWER POWER reset value false")
    }
    #[doc = "RNG POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_rng_power_power(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_ecb_tasks_startecb(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn write_ecb_tasks_stopecb(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_ecb_events_endecb(&self) -> MemResult<u32> {
        todo!("read ECB EVENTS_ENDECB reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "ECB EVENTS_ENDECB: ECB block encrypt complete."]
    #[inline]
    pub fn write_ecb_events_endecb(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_ecb_events_errorecb(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "ECB EVENTS_ERRORECB: ECB block encrypt aborted due to a STOPECB task or due to an error."]
    #[inline]
    pub fn write_ecb_events_errorecb(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_ecb_intenset_endecb(&self) -> MemResult<bool> {
        todo!("read ECB INTENSET ENDECB reset value false")
    }
    #[doc = "ECB INTENSET ENDECB: Enable interrupt on ENDECB event."]
    #[inline]
    pub fn write_ecb_intenset_endecb(&mut self, _value: bool) -> MemResult<()> {
        todo!("write ECB INTENSET ENDECB reset value false")
    }
    #[doc = "ECB INTENSET ERRORECB: Enable interrupt on ERRORECB event."]
    #[inline]
    pub fn read_ecb_intenset_errorecb(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_ecb_intenclr_endecb(&self) -> MemResult<bool> {
        todo!("read ECB INTENCLR ENDECB reset value false")
    }
    #[doc = "ECB INTENCLR ENDECB: Disable interrupt on ENDECB event."]
    #[inline]
    pub fn write_ecb_intenclr_endecb(&mut self, _value: bool) -> MemResult<()> {
        todo!("write ECB INTENCLR ENDECB reset value false")
    }
    #[doc = "ECB INTENCLR ERRORECB: Disable interrupt on ERRORECB event."]
    #[inline]
    pub fn read_ecb_intenclr_errorecb(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn write_aarccm_tasks_start(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_aarccm_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_events_end(&self) -> MemResult<u32> {
        todo ! ("read AAR EVENTS_END, CCM EVENTS_ENDKSGEN reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "AAR EVENTS_END: Address resolution procedure completed.\n\nCCM EVENTS_ENDKSGEN: Keystream generation completed."]
    #[inline]
    pub fn write_aarccm_events_end(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_events_resolved(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_aarccm_events_notresolved(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_aarccm_intenset_end(&self) -> MemResult<bool> {
        todo!("read AAR INTENSET END, CCM INTENSET ENDKSGEN reset value false")
    }
    #[doc = "AAR INTENSET END: Enable interrupt on END event.\n\nCCM INTENSET ENDKSGEN: Enable interrupt on ENDKSGEN event."]
    #[inline]
    pub fn write_aarccm_intenset_end(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_intenset_resolved(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_aarccm_intenset_notresolved(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_aarccm_intenclr_end(&self) -> MemResult<bool> {
        todo!("read AAR INTENCLR END, CCM INTENCLR ENDKSGEN reset value false")
    }
    #[doc = "AAR INTENCLR END: Disable interrupt on ENDKSGEN event.\n\nCCM INTENCLR ENDKSGEN: Disable interrupt on ENDKSGEN event."]
    #[inline]
    pub fn write_aarccm_intenclr_end(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_intenclr_resolved(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_aarccm_intenclr_notresolved(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_aarccm_irkptr(&self) -> MemResult<u32> {
        todo ! ("read AAR IRKPTR, CCM CNFPTR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "AAR IRKPTR: Pointer to the IRK data structure.\n\nCCM CNFPTR: Pointer to a data structure holding AES key and NONCE vector."]
    #[inline]
    pub fn write_aarccm_irkptr(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_addrptr(&self) -> MemResult<u32> {
        todo ! ("read AAR ADDRPTR, CCM OUTPTR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "AAR ADDRPTR: Pointer to the resolvable address (6 bytes).\n\nCCM OUTPTR: Pointer to the output packet."]
    #[inline]
    pub fn write_aarccm_addrptr(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_scratchptr(&self) -> MemResult<u32> {
        todo ! ("read AAR SCRATCHPTR, CCM SCRATCHPTR reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "AAR SCRATCHPTR: Pointer to a scratch data area used for temporary storage during resolution. A minimum of 3 bytes must be reserved.\n\nCCM SCRATCHPTR: Pointer to a scratch data area used for temporary storage during resolution. A minimum of 43 bytes must be reserved."]
    #[inline]
    pub fn write_aarccm_scratchptr(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_aarccm_power_power(&self) -> MemResult<bool> {
        todo!("read AAR POWER POWER, CCM POWER POWER reset value false")
    }
    #[doc = "AAR POWER POWER: Peripheral power control.\n\nCCM POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_aarccm_power_power(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn write_ccm_tasks_crypt(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_ccm_shorts_endksgen_crypt(&self) -> MemResult<bool> {
    ...
    #[doc = "WDT EVENTS_TIMEOUT: Watchdog timeout."]
    #[inline]
    pub fn write_wdt_events_timeout(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_wdt_intenset_timeout(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_wdt_intenclr_timeout(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_wdt_config_sleep(&self) -> MemResult<bool> {
        todo!("read WDT CONFIG SLEEP reset value true")
    }
    #[doc = "WDT CONFIG SLEEP: Configure the watchdog to pause or not while the CPU is sleeping."]
    #[inline]
    pub fn write_wdt_config_sleep(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_qdec_events_samplerdy(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_qdec_events_reportrdy(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_qdec_events_accof(&self) -> MemResult<u32> {
        todo!("read QDEC EVENTS_ACCOF reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "QDEC EVENTS_ACCOF: ACC or ACCDBL register overflow."]
    #[inline]
    pub fn write_qdec_events_accof(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_qdec_shorts_reportrdy_readclracc(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_shorts_samplerdy_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_intenset_samplerdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_intenset_reportrdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_intenset_accof(&self) -> MemResult<bool> {
        todo!("read QDEC INTENSET ACCOF reset value false")
    }
    #[doc = "QDEC INTENSET ACCOF: Enable interrupt on ACCOF event."]
    #[inline]
    pub fn write_qdec_intenset_accof(&mut self, _value: bool) -> MemResult<()> {
        todo!("write QDEC INTENSET ACCOF reset value false")
    }
    #[doc = "QDEC INTENCLR SAMPLERDY: Disable interrupt on SAMPLERDY event."]
    #[inline]
    pub fn read_qdec_intenclr_samplerdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_intenclr_reportrdy(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_qdec_intenclr_accof(&self) -> MemResult<bool> {
        todo!("read QDEC INTENCLR ACCOF reset value false")
    }
    #[doc = "QDEC INTENCLR ACCOF: Disable interrupt on ACCOF event."]
    #[inline]
    pub fn write_qdec_intenclr_accof(&mut self, _value: bool) -> MemResult<()> {
        todo!("write QDEC INTENCLR ACCOF reset value false")
    }
    #[doc = "QDEC ENABLE ENABLE: Enable or disable QDEC."]
    #[inline]
    pub fn read_qdec_enable_enable(&self) -> MemResult<bool> {
        todo!("read QDEC ENABLE ENABLE reset value false")
    }
    #[doc = "QDEC ENABLE ENABLE: Enable or disable QDEC."]
    #[inline]
    pub fn write_qdec_enable_enable(&mut self, _value: bool) -> MemResult<()> {
        todo!("write QDEC ENABLE ENABLE reset value false")
    }
    #[doc = "QDEC LEDPOL LEDPOL: LED output pin polarity."]
    #[inline]
    pub fn read_qdec_ledpol_ledpol(&self) -> MemResult<bool> {
        todo!("read QDEC LEDPOL LEDPOL reset value false")
    }
    #[doc = "QDEC LEDPOL LEDPOL: LED output pin polarity."]
    #[inline]
    pub fn write_qdec_ledpol_ledpol(&mut self, _value: bool) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_qdec_sample(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_qdec_acc(&self) -> MemResult<u32> {
    ...
    #[doc = "QDEC PSELLED: Pin select for LED output."]
    #[inline]
    pub fn write_qdec_pselled(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_qdec_ledpre_ledpre(&self) -> MemResult<u16> {
        todo!("read QDEC LEDPRE LEDPRE reset value 0x10 mask 0x1ff")
    }
    #[doc = "QDEC LEDPRE LEDPRE: Period in us the LED in switched on prior to sampling."]
    #[inline]
    pub fn write_qdec_ledpre_ledpre(&mut self, _value: u16) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_qdec_power_power(&self) -> MemResult<bool> {
        todo!("read QDEC POWER POWER reset value false")
    }
    #[doc = "QDEC POWER POWER: Peripheral power control."]
    #[inline]
    pub fn write_qdec_power_power(&mut self, _value: bool) -> MemResult<()> {
        todo!("write QDEC POWER POWER reset value false")
    }
    #[doc = "LPCOMP TASKS_START: Start the comparator."]
    #[inline]
    pub fn write_lpcomp_tasks_start(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn write_lpcomp_tasks_stop(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn write_lpcomp_tasks_sample(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_lpcomp_events_ready(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "LPCOMP EVENTS_READY: LPCOMP is ready and output is valid."]
    #[inline]
    pub fn write_lpcomp_events_ready(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_lpcomp_events_down(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "LPCOMP EVENTS_DOWN: Input voltage crossed the threshold going down."]
    #[inline]
    pub fn write_lpcomp_events_down(&mut self, _value: u32) -> MemResult<()> {
        todo!(
    ...
    #[inline]
    pub fn read_lpcomp_events_up(&self) -> MemResult<u32> {
        todo!("read LPCOMP EVENTS_UP reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "LPCOMP EVENTS_UP: Input voltage crossed the threshold going up."]
    #[inline]
    pub fn write_lpcomp_events_up(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_lpcomp_events_cross(&self) -> MemResult<u32> {
        todo!(
    ...
    #[doc = "LPCOMP EVENTS_CROSS: Input voltage crossed the threshold in any direction."]
    #[inline]
    pub fn write_lpcomp_events_cross(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_lpcomp_shorts_ready_sample(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_shorts_ready_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_shorts_down_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_shorts_up_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_shorts_cross_stop(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenset_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenset_down(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenset_up(&self) -> MemResult<bool> {
        todo!("read LPCOMP INTENSET UP reset value false")
    }
    #[doc = "LPCOMP INTENSET UP: Enable interrupt on UP event."]
    #[inline]
    pub fn write_lpcomp_intenset_up(&mut self, _value: bool) -> MemResult<()> {
        todo!("write LPCOMP INTENSET UP reset value false")
    }
    #[doc = "LPCOMP INTENSET CROSS: Enable interrupt on CROSS event."]
    #[inline]
    pub fn read_lpcomp_intenset_cross(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenclr_ready(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenclr_down(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_intenclr_up(&self) -> MemResult<bool> {
        todo!("read LPCOMP INTENCLR UP reset value false")
    }
    #[doc = "LPCOMP INTENCLR UP: Disable interrupt on UP event."]
    #[inline]
    pub fn write_lpcomp_intenclr_up(&mut self, _value: bool) -> MemResult<()> {
        todo!("write LPCOMP INTENCLR UP reset value false")
    }
    #[doc = "LPCOMP INTENCLR CROSS: Disable interrupt on CROSS event."]
    #[inline]
    pub fn read_lpcomp_intenclr_cross(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_result_result(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_lpcomp_extrefsel_extrefsel(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_nvmc_erasepage(&self) -> MemResult<u32> {
        todo ! ("read NVMC ERASEPAGE, NVMC ERASEPCR1 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "NVMC ERASEPAGE: Register for erasing a non-protected non-volatile memory page.\n\nNVMC ERASEPCR1: Register for erasing a non-protected non-volatile memory page."]
    #[inline]
    pub fn write_nvmc_erasepage(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvmc_eraseall_eraseall(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_nvmc_erasepcr0(&self) -> MemResult<u32> {
        todo!("read NVMC ERASEPCR0 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "NVMC ERASEPCR0: Register for erasing a protected non-volatile memory page."]
    #[inline]
    pub fn write_nvmc_erasepcr0(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_nvmc_eraseuicr_eraseuicr(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_ppi_chen_ch0(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(0))
    }
    #[doc = "PPI CHEN CH0: Enable PPI channel 0."]
    #[inline]
    pub fn write_ppi_chen_ch0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(0, _value))
    }
    #[doc = "PPI CHEN CH1: Enable PPI channel 1."]
    #[inline]
    pub fn read_ppi_chen_ch1(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(1))
    }
    #[doc = "PPI CHEN CH1: Enable PPI channel 1."]
    #[inline]
    pub fn write_ppi_chen_ch1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(1, _value))
    }
    #[doc = "PPI CHEN CH2: Enable PPI channel 2."]
    #[inline]
    pub fn read_ppi_chen_ch2(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(2))
    }
    #[doc = "PPI CHEN CH2: Enable PPI channel 2."]
    #[inline]
    pub fn write_ppi_chen_ch2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(2, _value))
    }
    #[doc = "PPI CHEN CH3: Enable PPI channel 3."]
    #[inline]
    pub fn read_ppi_chen_ch3(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(3))
    }
    #[doc = "PPI CHEN CH3: Enable PPI channel 3."]
    #[inline]
    pub fn write_ppi_chen_ch3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(3, _value))
    }
    #[doc = "PPI CHEN CH4: Enable PPI channel 4."]
    #[inline]
    pub fn read_ppi_chen_ch4(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(4))
    }
    #[doc = "PPI CHEN CH4: Enable PPI channel 4."]
    #[inline]
    pub fn write_ppi_chen_ch4(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(4, _value))
    }
    #[doc = "PPI CHEN CH5: Enable PPI channel 5."]
    #[inline]
    pub fn read_ppi_chen_ch5(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(5))
    }
    #[doc = "PPI CHEN CH5: Enable PPI channel 5."]
    #[inline]
    pub fn write_ppi_chen_ch5(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(5, _value))
    }
    #[doc = "PPI CHEN CH6: Enable PPI channel 6."]
    #[inline]
    pub fn read_ppi_chen_ch6(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(6))
    }
    #[doc = "PPI CHEN CH6: Enable PPI channel 6."]
    #[inline]
    pub fn write_ppi_chen_ch6(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(6, _value))
    }
    #[doc = "PPI CHEN CH7: Enable PPI channel 7."]
    #[inline]
    pub fn read_ppi_chen_ch7(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(7))
    }
    #[doc = "PPI CHEN CH7: Enable PPI channel 7."]
    #[inline]
    pub fn write_ppi_chen_ch7(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(7, _value))
    }
    #[doc = "PPI CHEN CH8: Enable PPI channel 8."]
    #[inline]
    pub fn read_ppi_chen_ch8(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(8))
    }
    #[doc = "PPI CHEN CH8: Enable PPI channel 8."]
    #[inline]
    pub fn write_ppi_chen_ch8(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(8, _value))
    }
    #[doc = "PPI CHEN CH9: Enable PPI channel 9."]
    #[inline]
    pub fn read_ppi_chen_ch9(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(9))
    }
    #[doc = "PPI CHEN CH9: Enable PPI channel 9."]
    #[inline]
    pub fn write_ppi_chen_ch9(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(9, _value))
    }
    #[doc = "PPI CHEN CH10: Enable PPI channel 10."]
    #[inline]
    pub fn read_ppi_chen_ch10(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(10))
    }
    #[doc = "PPI CHEN CH10: Enable PPI channel 10."]
    #[inline]
    pub fn write_ppi_chen_ch10(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(10, _value))
    }
    #[doc = "PPI CHEN CH11: Enable PPI channel 11."]
    #[inline]
    pub fn read_ppi_chen_ch11(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(11))
    }
    #[doc = "PPI CHEN CH11: Enable PPI channel 11."]
    #[inline]
    pub fn write_ppi_chen_ch11(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(11, _value))
    }
    #[doc = "PPI CHEN CH12: Enable PPI channel 12."]
    #[inline]
    pub fn read_ppi_chen_ch12(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(12))
    }
    #[doc = "PPI CHEN CH12: Enable PPI channel 12."]
    #[inline]
    pub fn write_ppi_chen_ch12(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(12, _value))
    }
    #[doc = "PPI CHEN CH13: Enable PPI channel 13."]
    #[inline]
    pub fn read_ppi_chen_ch13(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(13))
    }
    #[doc = "PPI CHEN CH13: Enable PPI channel 13."]
    #[inline]
    pub fn write_ppi_chen_ch13(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(13, _value))
    }
    #[doc = "PPI CHEN CH14: Enable PPI channel 14."]
    #[inline]
    pub fn read_ppi_chen_ch14(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(14))
    }
    #[doc = "PPI CHEN CH14: Enable PPI channel 14."]
    #[inline]
    pub fn write_ppi_chen_ch14(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(14, _value))
    }
    #[doc = "PPI CHEN CH15: Enable PPI channel 15."]
    #[inline]
    pub fn read_ppi_chen_ch15(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(15))
    }
    #[doc = "PPI CHEN CH15: Enable PPI channel 15."]
    #[inline]
    pub fn write_ppi_chen_ch15(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(15, _value))
    }
    #[doc = "PPI CHEN CH20: Enable PPI channel 20."]
    #[inline]
    pub fn read_ppi_chen_ch20(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(20))
    }
    #[doc = "PPI CHEN CH20: Enable PPI channel 20."]
    #[inline]
    pub fn write_ppi_chen_ch20(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(20, _value))
    }
    #[doc = "PPI CHEN CH21: Enable PPI channel 21."]
    #[inline]
    pub fn read_ppi_chen_ch21(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(21))
    }
    #[doc = "PPI CHEN CH21: Enable PPI channel 21."]
    #[inline]
    pub fn write_ppi_chen_ch21(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(21, _value))
    }
    #[doc = "PPI CHEN CH22: Enable PPI channel 22."]
    #[inline]
    pub fn read_ppi_chen_ch22(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(22))
    }
    #[doc = "PPI CHEN CH22: Enable PPI channel 22."]
    #[inline]
    pub fn write_ppi_chen_ch22(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(22, _value))
    }
    #[doc = "PPI CHEN CH23: Enable PPI channel 23."]
    #[inline]
    pub fn read_ppi_chen_ch23(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(23))
    }
    #[doc = "PPI CHEN CH23: Enable PPI channel 23."]
    #[inline]
    pub fn write_ppi_chen_ch23(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(23, _value))
    }
    #[doc = "PPI CHEN CH24: Enable PPI channel 24."]
    #[inline]
    pub fn read_ppi_chen_ch24(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(24))
    }
    #[doc = "PPI CHEN CH24: Enable PPI channel 24."]
    #[inline]
    pub fn write_ppi_chen_ch24(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(24, _value))
    }
    #[doc = "PPI CHEN CH25: Enable PPI channel 25."]
    #[inline]
    pub fn read_ppi_chen_ch25(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(25))
    }
    #[doc = "PPI CHEN CH25: Enable PPI channel 25."]
    #[inline]
    pub fn write_ppi_chen_ch25(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(25, _value))
    }
    #[doc = "PPI CHEN CH26: Enable PPI channel 26."]
    #[inline]
    pub fn read_ppi_chen_ch26(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(26))
    }
    #[doc = "PPI CHEN CH26: Enable PPI channel 26."]
    #[inline]
    pub fn write_ppi_chen_ch26(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(26, _value))
    }
    #[doc = "PPI CHEN CH27: Enable PPI channel 27."]
    #[inline]
    pub fn read_ppi_chen_ch27(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(27))
    }
    #[doc = "PPI CHEN CH27: Enable PPI channel 27."]
    #[inline]
    pub fn write_ppi_chen_ch27(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(27, _value))
    }
    #[doc = "PPI CHEN CH28: Enable PPI channel 28."]
    #[inline]
    pub fn read_ppi_chen_ch28(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(28))
    }
    #[doc = "PPI CHEN CH28: Enable PPI channel 28."]
    #[inline]
    pub fn write_ppi_chen_ch28(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(28, _value))
    }
    #[doc = "PPI CHEN CH29: Enable PPI channel 29."]
    #[inline]
    pub fn read_ppi_chen_ch29(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(29))
    }
    #[doc = "PPI CHEN CH29: Enable PPI channel 29."]
    #[inline]
    pub fn write_ppi_chen_ch29(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(29, _value))
    }
    #[doc = "PPI CHEN CH30: Enable PPI channel 30."]
    #[inline]
    pub fn read_ppi_chen_ch30(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(30))
    }
    #[doc = "PPI CHEN CH30: Enable PPI channel 30."]
    #[inline]
    pub fn write_ppi_chen_ch30(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(30, _value))
    }
    #[doc = "PPI CHEN CH31: Enable PPI channel 31."]
    #[inline]
    pub fn read_ppi_chen_ch31(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(31))
    }
    #[doc = "PPI CHEN CH31: Enable PPI channel 31."]
    #[inline]
    pub fn write_ppi_chen_ch31(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.ppi_set_on(31, _value))
    }
    #[doc = "PPI CHENSET CH0: Enable PPI channel 0."]
    #[inline]
    pub fn read_ppi_chenset_ch0(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(0))
    }
    #[doc = "PPI CHENSET CH0: Enable PPI channel 0."]
    #[inline]
    pub fn write_ppi_chenset_ch0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch1(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(1))
    }
    #[doc = "PPI CHENSET CH1: Enable PPI channel 1."]
    #[inline]
    pub fn write_ppi_chenset_ch1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch2(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(2))
    }
    #[doc = "PPI CHENSET CH2: Enable PPI channel 2."]
    #[inline]
    pub fn write_ppi_chenset_ch2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch3(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(3))
    }
    #[doc = "PPI CHENSET CH3: Enable PPI channel 3."]
    #[inline]
    pub fn write_ppi_chenset_ch3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch4(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(4))
    }
    #[doc = "PPI CHENSET CH4: Enable PPI channel 4."]
    #[inline]
    pub fn write_ppi_chenset_ch4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch5(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(5))
    }
    #[doc = "PPI CHENSET CH5: Enable PPI channel 5."]
    #[inline]
    pub fn write_ppi_chenset_ch5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch6(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(6))
    }
    #[doc = "PPI CHENSET CH6: Enable PPI channel 6."]
    #[inline]
    pub fn write_ppi_chenset_ch6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch7(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(7))
    }
    #[doc = "PPI CHENSET CH7: Enable PPI channel 7."]
    #[inline]
    pub fn write_ppi_chenset_ch7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch8(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(8))
    }
    #[doc = "PPI CHENSET CH8: Enable PPI channel 8."]
    #[inline]
    pub fn write_ppi_chenset_ch8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch9(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(9))
    }
    #[doc = "PPI CHENSET CH9: Enable PPI channel 9."]
    #[inline]
    pub fn write_ppi_chenset_ch9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch10(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(10))
    }
    #[doc = "PPI CHENSET CH10: Enable PPI channel 10."]
    #[inline]
    pub fn write_ppi_chenset_ch10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch11(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(11))
    }
    #[doc = "PPI CHENSET CH11: Enable PPI channel 11."]
    #[inline]
    pub fn write_ppi_chenset_ch11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch12(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(12))
    }
    #[doc = "PPI CHENSET CH12: Enable PPI channel 12."]
    #[inline]
    pub fn write_ppi_chenset_ch12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch13(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(13))
    }
    #[doc = "PPI CHENSET CH13: Enable PPI channel 13."]
    #[inline]
    pub fn write_ppi_chenset_ch13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch14(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(14))
    }
    #[doc = "PPI CHENSET CH14: Enable PPI channel 14."]
    #[inline]
    pub fn write_ppi_chenset_ch14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch15(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(15))
    }
    #[doc = "PPI CHENSET CH15: Enable PPI channel 15."]
    #[inline]
    pub fn write_ppi_chenset_ch15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch20(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(20))
    }
    #[doc = "PPI CHENSET CH20: Enable PPI channel 20."]
    #[inline]
    pub fn write_ppi_chenset_ch20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch21(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(21))
    }
    #[doc = "PPI CHENSET CH21: Enable PPI channel 21."]
    #[inline]
    pub fn write_ppi_chenset_ch21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch22(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(22))
    }
    #[doc = "PPI CHENSET CH22: Enable PPI channel 22."]
    #[inline]
    pub fn write_ppi_chenset_ch22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch23(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(23))
    }
    #[doc = "PPI CHENSET CH23: Enable PPI channel 23."]
    #[inline]
    pub fn write_ppi_chenset_ch23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch24(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(24))
    }
    #[doc = "PPI CHENSET CH24: Enable PPI channel 24."]
    #[inline]
    pub fn write_ppi_chenset_ch24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch25(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(25))
    }
    #[doc = "PPI CHENSET CH25: Enable PPI channel 25."]
    #[inline]
    pub fn write_ppi_chenset_ch25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch26(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(26))
    }
    #[doc = "PPI CHENSET CH26: Enable PPI channel 26."]
    #[inline]
    pub fn write_ppi_chenset_ch26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch27(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(27))
    }
    #[doc = "PPI CHENSET CH27: Enable PPI channel 27."]
    #[inline]
    pub fn write_ppi_chenset_ch27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch28(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(28))
    }
    #[doc = "PPI CHENSET CH28: Enable PPI channel 28."]
    #[inline]
    pub fn write_ppi_chenset_ch28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch29(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(29))
    }
    #[doc = "PPI CHENSET CH29: Enable PPI channel 29."]
    #[inline]
    pub fn write_ppi_chenset_ch29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch30(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(30))
    }
    #[doc = "PPI CHENSET CH30: Enable PPI channel 30."]
    #[inline]
    pub fn write_ppi_chenset_ch30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenset_ch31(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(31))
    }
    #[doc = "PPI CHENSET CH31: Enable PPI channel 31."]
    #[inline]
    pub fn write_ppi_chenset_ch31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch0(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(0))
    }
    #[doc = "PPI CHENCLR CH0: Disable PPI channel 0."]
    #[inline]
    pub fn write_ppi_chenclr_ch0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch1(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(1))
    }
    #[doc = "PPI CHENCLR CH1: Disable PPI channel 1."]
    #[inline]
    pub fn write_ppi_chenclr_ch1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch2(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(2))
    }
    #[doc = "PPI CHENCLR CH2: Disable PPI channel 2."]
    #[inline]
    pub fn write_ppi_chenclr_ch2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch3(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(3))
    }
    #[doc = "PPI CHENCLR CH3: Disable PPI channel 3."]
    #[inline]
    pub fn write_ppi_chenclr_ch3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch4(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(4))
    }
    #[doc = "PPI CHENCLR CH4: Disable PPI channel 4."]
    #[inline]
    pub fn write_ppi_chenclr_ch4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch5(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(5))
    }
    #[doc = "PPI CHENCLR CH5: Disable PPI channel 5."]
    #[inline]
    pub fn write_ppi_chenclr_ch5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch6(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(6))
    }
    #[doc = "PPI CHENCLR CH6: Disable PPI channel 6."]
    #[inline]
    pub fn write_ppi_chenclr_ch6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch7(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(7))
    }
    #[doc = "PPI CHENCLR CH7: Disable PPI channel 7."]
    #[inline]
    pub fn write_ppi_chenclr_ch7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch8(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(8))
    }
    #[doc = "PPI CHENCLR CH8: Disable PPI channel 8."]
    #[inline]
    pub fn write_ppi_chenclr_ch8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch9(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(9))
    }
    #[doc = "PPI CHENCLR CH9: Disable PPI channel 9."]
    #[inline]
    pub fn write_ppi_chenclr_ch9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch10(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(10))
    }
    #[doc = "PPI CHENCLR CH10: Disable PPI channel 10."]
    #[inline]
    pub fn write_ppi_chenclr_ch10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch11(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(11))
    }
    #[doc = "PPI CHENCLR CH11: Disable PPI channel 11."]
    #[inline]
    pub fn write_ppi_chenclr_ch11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch12(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(12))
    }
    #[doc = "PPI CHENCLR CH12: Disable PPI channel 12."]
    #[inline]
    pub fn write_ppi_chenclr_ch12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch13(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(13))
    }
    #[doc = "PPI CHENCLR CH13: Disable PPI channel 13."]
    #[inline]
    pub fn write_ppi_chenclr_ch13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch14(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(14))
    }
    #[doc = "PPI CHENCLR CH14: Disable PPI channel 14."]
    #[inline]
    pub fn write_ppi_chenclr_ch14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch15(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(15))
    }
    #[doc = "PPI CHENCLR CH15: Disable PPI channel 15."]
    #[inline]
    pub fn write_ppi_chenclr_ch15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch20(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(20))
    }
    #[doc = "PPI CHENCLR CH20: Disable PPI channel 20."]
    #[inline]
    pub fn write_ppi_chenclr_ch20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch21(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(21))
    }
    #[doc = "PPI CHENCLR CH21: Disable PPI channel 21."]
    #[inline]
    pub fn write_ppi_chenclr_ch21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch22(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(22))
    }
    #[doc = "PPI CHENCLR CH22: Disable PPI channel 22."]
    #[inline]
    pub fn write_ppi_chenclr_ch22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch23(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(23))
    }
    #[doc = "PPI CHENCLR CH23: Disable PPI channel 23."]
    #[inline]
    pub fn write_ppi_chenclr_ch23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch24(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(24))
    }
    #[doc = "PPI CHENCLR CH24: Disable PPI channel 24."]
    #[inline]
    pub fn write_ppi_chenclr_ch24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch25(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(25))
    }
    #[doc = "PPI CHENCLR CH25: Disable PPI channel 25."]
    #[inline]
    pub fn write_ppi_chenclr_ch25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch26(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(26))
    }
    #[doc = "PPI CHENCLR CH26: Disable PPI channel 26."]
    #[inline]
    pub fn write_ppi_chenclr_ch26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch27(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(27))
    }
    #[doc = "PPI CHENCLR CH27: Disable PPI channel 27."]
    #[inline]
    pub fn write_ppi_chenclr_ch27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch28(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(28))
    }
    #[doc = "PPI CHENCLR CH28: Disable PPI channel 28."]
    #[inline]
    pub fn write_ppi_chenclr_ch28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch29(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(29))
    }
    #[doc = "PPI CHENCLR CH29: Disable PPI channel 29."]
    #[inline]
    pub fn write_ppi_chenclr_ch29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch30(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(30))
    }
    #[doc = "PPI CHENCLR CH30: Disable PPI channel 30."]
    #[inline]
    pub fn write_ppi_chenclr_ch30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chenclr_ch31(&self) -> MemResult<bool> {
        Ok(self.ppi_is_on(31))
    }
    #[doc = "PPI CHENCLR CH31: Disable PPI channel 31."]
    #[inline]
    pub fn write_ppi_chenclr_ch31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_ppi_chgn_ch0(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 0))
    }
    #[doc = "PPI CHG[%s] CH0: Include CH0 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch0(
        ...
        Ok(self.ppi_set_included(_dim, 0, _value))
    }
    #[doc = "PPI CHG[%s] CH1: Include CH1 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch1(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 1))
    }
    #[doc = "PPI CHG[%s] CH1: Include CH1 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch1(
        ...
        Ok(self.ppi_set_included(_dim, 1, _value))
    }
    #[doc = "PPI CHG[%s] CH2: Include CH2 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch2(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 2))
    }
    #[doc = "PPI CHG[%s] CH2: Include CH2 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch2(
        ...
        Ok(self.ppi_set_included(_dim, 2, _value))
    }
    #[doc = "PPI CHG[%s] CH3: Include CH3 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch3(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 3))
    }
    #[doc = "PPI CHG[%s] CH3: Include CH3 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch3(
        ...
        Ok(self.ppi_set_included(_dim, 3, _value))
    }
    #[doc = "PPI CHG[%s] CH4: Include CH4 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch4(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 4))
    }
    #[doc = "PPI CHG[%s] CH4: Include CH4 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch4(
        ...
        Ok(self.ppi_set_included(_dim, 4, _value))
    }
    #[doc = "PPI CHG[%s] CH5: Include CH5 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch5(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 5))
    }
    #[doc = "PPI CHG[%s] CH5: Include CH5 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch5(
        ...
        Ok(self.ppi_set_included(_dim, 5, _value))
    }
    #[doc = "PPI CHG[%s] CH6: Include CH6 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch6(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 6))
    }
    #[doc = "PPI CHG[%s] CH6: Include CH6 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch6(
        ...
        Ok(self.ppi_set_included(_dim, 6, _value))
    }
    #[doc = "PPI CHG[%s] CH7: Include CH7 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch7(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 7))
    }
    #[doc = "PPI CHG[%s] CH7: Include CH7 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch7(
        ...
        Ok(self.ppi_set_included(_dim, 7, _value))
    }
    #[doc = "PPI CHG[%s] CH8: Include CH8 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch8(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 8))
    }
    #[doc = "PPI CHG[%s] CH8: Include CH8 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch8(
        ...
        Ok(self.ppi_set_included(_dim, 8, _value))
    }
    #[doc = "PPI CHG[%s] CH9: Include CH9 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch9(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 9))
    }
    #[doc = "PPI CHG[%s] CH9: Include CH9 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch9(
        ...
        Ok(self.ppi_set_included(_dim, 9, _value))
    }
    #[doc = "PPI CHG[%s] CH10: Include CH10 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch10(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 10))
    }
    #[doc = "PPI CHG[%s] CH10: Include CH10 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch10(
        ...
        Ok(self.ppi_set_included(_dim, 10, _value))
    }
    #[doc = "PPI CHG[%s] CH11: Include CH11 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch11(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 11))
    }
    #[doc = "PPI CHG[%s] CH11: Include CH11 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch11(
        ...
        Ok(self.ppi_set_included(_dim, 11, _value))
    }
    #[doc = "PPI CHG[%s] CH12: Include CH12 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch12(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 12))
    }
    #[doc = "PPI CHG[%s] CH12: Include CH12 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch12(
        ...
        Ok(self.ppi_set_included(_dim, 12, _value))
    }
    #[doc = "PPI CHG[%s] CH13: Include CH13 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch13(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 13))
    }
    #[doc = "PPI CHG[%s] CH13: Include CH13 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch13(
        ...
        Ok(self.ppi_set_included(_dim, 13, _value))
    }
    #[doc = "PPI CHG[%s] CH14: Include CH14 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch14(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 14))
    }
    #[doc = "PPI CHG[%s] CH14: Include CH14 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch14(
        ...
        Ok(self.ppi_set_included(_dim, 14, _value))
    }
    #[doc = "PPI CHG[%s] CH15: Include CH15 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch15(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 15))
    }
    #[doc = "PPI CHG[%s] CH15: Include CH15 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch15(
        ...
        Ok(self.ppi_set_included(_dim, 15, _value))
    }
    #[doc = "PPI CHG[%s] CH20: Include CH20 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch20(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 20))
    }
    #[doc = "PPI CHG[%s] CH20: Include CH20 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch20(
        ...
        Ok(self.ppi_set_included(_dim, 20, _value))
    }
    #[doc = "PPI CHG[%s] CH21: Include CH21 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch21(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 21))
    }
    #[doc = "PPI CHG[%s] CH21: Include CH21 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch21(
        ...
        Ok(self.ppi_set_included(_dim, 21, _value))
    }
    #[doc = "PPI CHG[%s] CH22: Include CH22 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch22(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 22))
    }
    #[doc = "PPI CHG[%s] CH22: Include CH22 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch22(
        ...
        Ok(self.ppi_set_included(_dim, 22, _value))
    }
    #[doc = "PPI CHG[%s] CH23: Include CH23 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch23(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 23))
    }
    #[doc = "PPI CHG[%s] CH23: Include CH23 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch23(
        ...
        Ok(self.ppi_set_included(_dim, 23, _value))
    }
    #[doc = "PPI CHG[%s] CH24: Include CH24 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch24(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 24))
    }
    #[doc = "PPI CHG[%s] CH24: Include CH24 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch24(
        ...
        Ok(self.ppi_set_included(_dim, 24, _value))
    }
    #[doc = "PPI CHG[%s] CH25: Include CH25 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch25(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 25))
    }
    #[doc = "PPI CHG[%s] CH25: Include CH25 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch25(
        ...
        Ok(self.ppi_set_included(_dim, 25, _value))
    }
    #[doc = "PPI CHG[%s] CH26: Include CH26 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch26(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 26))
    }
    #[doc = "PPI CHG[%s] CH26: Include CH26 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch26(
        ...
        Ok(self.ppi_set_included(_dim, 26, _value))
    }
    #[doc = "PPI CHG[%s] CH27: Include CH27 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch27(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 27))
    }
    #[doc = "PPI CHG[%s] CH27: Include CH27 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch27(
        ...
        Ok(self.ppi_set_included(_dim, 27, _value))
    }
    #[doc = "PPI CHG[%s] CH28: Include CH28 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch28(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 28))
    }
    #[doc = "PPI CHG[%s] CH28: Include CH28 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch28(
        ...
        Ok(self.ppi_set_included(_dim, 28, _value))
    }
    #[doc = "PPI CHG[%s] CH29: Include CH29 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch29(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 29))
    }
    #[doc = "PPI CHG[%s] CH29: Include CH29 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch29(
        ...
        Ok(self.ppi_set_included(_dim, 29, _value))
    }
    #[doc = "PPI CHG[%s] CH30: Include CH30 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch30(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 30))
    }
    #[doc = "PPI CHG[%s] CH30: Include CH30 in channel group."]
    #[inline]
    pub fn write_ppi_chgn_ch30(
        ...
        Ok(self.ppi_set_included(_dim, 30, _value))
    }
    #[doc = "PPI CHG[%s] CH31: Include CH31 in channel group."]
    #[inline]
    pub fn read_ppi_chgn_ch31(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.ppi_is_included(_dim, 31))
    }
    #[doc = "PPI CHG[%s] CH31: Include CH31 in channel group."]
    #[inline]
    ...
    #[inline]
    pub fn read_ficr_numramblock(&self) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_ficr_sizeramblocks(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_ficr_configid_hwid(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_ficr_overrideen_nrf_1mbit(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_ficr_overrideen_ble_1mbit(&self) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_ficr_nrf_1mbitn(&self, _dim: usize) -> MemResult<u32> {
        todo!(
    ...
    #[inline]
    pub fn read_ficr_ble_1mbitn(&self, _dim: usize) -> MemResult<u32> {
        todo!(
    ...
    #[inline]
    pub fn read_uicr_clenr0(&self) -> MemResult<u32> {
        todo!("read UICR CLENR0 reset value 0x00 mask 0xffffffffffffffff")
    }
    #[doc = "UICR CLENR0: Length of code region 0."]
    #[inline]
    pub fn write_uicr_clenr0(&mut self, _value: u32) -> MemResult<()> {
    ...
    #[inline]
    pub fn read_uicr_fwid_fwid(&self) -> MemResult<u16> {
    ...
    #[inline]
    pub fn read_uicr_bootloaderaddr(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_uicr_nrfhwn(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_uicr_customern(&self, _dim: usize) -> MemResult<u32> {
    ...
    #[inline]
    pub fn read_gpio_out_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].is_out_high())
    }
    #[doc = "GPIO OUT PIN0: Pin 0."]
    #[inline]
    pub fn write_gpio_out_pin0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[0].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN1: Pin 1."]
    #[inline]
    pub fn read_gpio_out_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].is_out_high())
    }
    #[doc = "GPIO OUT PIN1: Pin 1."]
    #[inline]
    pub fn write_gpio_out_pin1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[1].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN2: Pin 2."]
    #[inline]
    pub fn read_gpio_out_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].is_out_high())
    }
    #[doc = "GPIO OUT PIN2: Pin 2."]
    #[inline]
    pub fn write_gpio_out_pin2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[2].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN3: Pin 3."]
    #[inline]
    pub fn read_gpio_out_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].is_out_high())
    }
    #[doc = "GPIO OUT PIN3: Pin 3."]
    #[inline]
    pub fn write_gpio_out_pin3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[3].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN4: Pin 4."]
    #[inline]
    pub fn read_gpio_out_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].is_out_high())
    }
    #[doc = "GPIO OUT PIN4: Pin 4."]
    #[inline]
    pub fn write_gpio_out_pin4(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[4].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN5: Pin 5."]
    #[inline]
    pub fn read_gpio_out_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].is_out_high())
    }
    #[doc = "GPIO OUT PIN5: Pin 5."]
    #[inline]
    pub fn write_gpio_out_pin5(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[5].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN6: Pin 6."]
    #[inline]
    pub fn read_gpio_out_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].is_out_high())
    }
    #[doc = "GPIO OUT PIN6: Pin 6."]
    #[inline]
    pub fn write_gpio_out_pin6(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[6].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN7: Pin 7."]
    #[inline]
    pub fn read_gpio_out_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].is_out_high())
    }
    #[doc = "GPIO OUT PIN7: Pin 7."]
    #[inline]
    pub fn write_gpio_out_pin7(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[7].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN8: Pin 8."]
    #[inline]
    pub fn read_gpio_out_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].is_out_high())
    }
    #[doc = "GPIO OUT PIN8: Pin 8."]
    #[inline]
    pub fn write_gpio_out_pin8(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[8].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN9: Pin 9."]
    #[inline]
    pub fn read_gpio_out_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].is_out_high())
    }
    #[doc = "GPIO OUT PIN9: Pin 9."]
    #[inline]
    pub fn write_gpio_out_pin9(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[9].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN10: Pin 10."]
    #[inline]
    pub fn read_gpio_out_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].is_out_high())
    }
    #[doc = "GPIO OUT PIN10: Pin 10."]
    #[inline]
    pub fn write_gpio_out_pin10(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[10].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN11: Pin 11."]
    #[inline]
    pub fn read_gpio_out_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].is_out_high())
    }
    #[doc = "GPIO OUT PIN11: Pin 11."]
    #[inline]
    pub fn write_gpio_out_pin11(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[11].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN12: Pin 12."]
    #[inline]
    pub fn read_gpio_out_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].is_out_high())
    }
    #[doc = "GPIO OUT PIN12: Pin 12."]
    #[inline]
    pub fn write_gpio_out_pin12(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[12].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN13: Pin 13."]
    #[inline]
    pub fn read_gpio_out_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].is_out_high())
    }
    #[doc = "GPIO OUT PIN13: Pin 13."]
    #[inline]
    pub fn write_gpio_out_pin13(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[13].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN14: Pin 14."]
    #[inline]
    pub fn read_gpio_out_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].is_out_high())
    }
    #[doc = "GPIO OUT PIN14: Pin 14."]
    #[inline]
    pub fn write_gpio_out_pin14(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[14].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN15: Pin 15."]
    #[inline]
    pub fn read_gpio_out_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].is_out_high())
    }
    #[doc = "GPIO OUT PIN15: Pin 15."]
    #[inline]
    pub fn write_gpio_out_pin15(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[15].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN16: Pin 16."]
    #[inline]
    pub fn read_gpio_out_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].is_out_high())
    }
    #[doc = "GPIO OUT PIN16: Pin 16."]
    #[inline]
    pub fn write_gpio_out_pin16(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[16].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN17: Pin 17."]
    #[inline]
    pub fn read_gpio_out_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].is_out_high())
    }
    #[doc = "GPIO OUT PIN17: Pin 17."]
    #[inline]
    pub fn write_gpio_out_pin17(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[17].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN18: Pin 18."]
    #[inline]
    pub fn read_gpio_out_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].is_out_high())
    }
    #[doc = "GPIO OUT PIN18: Pin 18."]
    #[inline]
    pub fn write_gpio_out_pin18(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[18].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN19: Pin 19."]
    #[inline]
    pub fn read_gpio_out_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].is_out_high())
    }
    #[doc = "GPIO OUT PIN19: Pin 19."]
    #[inline]
    pub fn write_gpio_out_pin19(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[19].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN20: Pin 20."]
    #[inline]
    pub fn read_gpio_out_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].is_out_high())
    }
    #[doc = "GPIO OUT PIN20: Pin 20."]
    #[inline]
    pub fn write_gpio_out_pin20(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[20].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN21: Pin 21."]
    #[inline]
    pub fn read_gpio_out_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].is_out_high())
    }
    #[doc = "GPIO OUT PIN21: Pin 21."]
    #[inline]
    pub fn write_gpio_out_pin21(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[21].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN22: Pin 22."]
    #[inline]
    pub fn read_gpio_out_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].is_out_high())
    }
    #[doc = "GPIO OUT PIN22: Pin 22."]
    #[inline]
    pub fn write_gpio_out_pin22(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[22].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN23: Pin 23."]
    #[inline]
    pub fn read_gpio_out_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].is_out_high())
    }
    #[doc = "GPIO OUT PIN23: Pin 23."]
    #[inline]
    pub fn write_gpio_out_pin23(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[23].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN24: Pin 24."]
    #[inline]
    pub fn read_gpio_out_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].is_out_high())
    }
    #[doc = "GPIO OUT PIN24: Pin 24."]
    #[inline]
    pub fn write_gpio_out_pin24(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[24].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN25: Pin 25."]
    #[inline]
    pub fn read_gpio_out_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].is_out_high())
    }
    #[doc = "GPIO OUT PIN25: Pin 25."]
    #[inline]
    pub fn write_gpio_out_pin25(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[25].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN26: Pin 26."]
    #[inline]
    pub fn read_gpio_out_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].is_out_high())
    }
    #[doc = "GPIO OUT PIN26: Pin 26."]
    #[inline]
    pub fn write_gpio_out_pin26(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[26].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN27: Pin 27."]
    #[inline]
    pub fn read_gpio_out_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].is_out_high())
    }
    #[doc = "GPIO OUT PIN27: Pin 27."]
    #[inline]
    pub fn write_gpio_out_pin27(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[27].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN28: Pin 28."]
    #[inline]
    pub fn read_gpio_out_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].is_out_high())
    }
    #[doc = "GPIO OUT PIN28: Pin 28."]
    #[inline]
    pub fn write_gpio_out_pin28(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[28].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN29: Pin 29."]
    #[inline]
    pub fn read_gpio_out_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].is_out_high())
    }
    #[doc = "GPIO OUT PIN29: Pin 29."]
    #[inline]
    pub fn write_gpio_out_pin29(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[29].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN30: Pin 30."]
    #[inline]
    pub fn read_gpio_out_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].is_out_high())
    }
    #[doc = "GPIO OUT PIN30: Pin 30."]
    #[inline]
    pub fn write_gpio_out_pin30(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[30].set_out_high(_value))
    }
    #[doc = "GPIO OUT PIN31: Pin 31."]
    #[inline]
    pub fn read_gpio_out_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].is_out_high())
    }
    #[doc = "GPIO OUT PIN31: Pin 31."]
    #[inline]
    pub fn write_gpio_out_pin31(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[31].set_out_high(_value))
    }
    #[doc = "GPIO OUTSET PIN0: Pin 0."]
    #[inline]
    pub fn read_gpio_outset_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN0: Pin 0."]
    #[inline]
    pub fn write_gpio_outset_pin0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN1: Pin 1."]
    #[inline]
    pub fn write_gpio_outset_pin1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN2: Pin 2."]
    #[inline]
    pub fn write_gpio_outset_pin2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN3: Pin 3."]
    #[inline]
    pub fn write_gpio_outset_pin3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN4: Pin 4."]
    #[inline]
    pub fn write_gpio_outset_pin4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN5: Pin 5."]
    #[inline]
    pub fn write_gpio_outset_pin5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN6: Pin 6."]
    #[inline]
    pub fn write_gpio_outset_pin6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN7: Pin 7."]
    #[inline]
    pub fn write_gpio_outset_pin7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN8: Pin 8."]
    #[inline]
    pub fn write_gpio_outset_pin8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN9: Pin 9."]
    #[inline]
    pub fn write_gpio_outset_pin9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN10: Pin 10."]
    #[inline]
    pub fn write_gpio_outset_pin10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN11: Pin 11."]
    #[inline]
    pub fn write_gpio_outset_pin11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN12: Pin 12."]
    #[inline]
    pub fn write_gpio_outset_pin12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN13: Pin 13."]
    #[inline]
    pub fn write_gpio_outset_pin13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN14: Pin 14."]
    #[inline]
    pub fn write_gpio_outset_pin14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN15: Pin 15."]
    #[inline]
    pub fn write_gpio_outset_pin15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN16: Pin 16."]
    #[inline]
    pub fn write_gpio_outset_pin16(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN17: Pin 17."]
    #[inline]
    pub fn write_gpio_outset_pin17(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN18: Pin 18."]
    #[inline]
    pub fn write_gpio_outset_pin18(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN19: Pin 19."]
    #[inline]
    pub fn write_gpio_outset_pin19(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN20: Pin 20."]
    #[inline]
    pub fn write_gpio_outset_pin20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN21: Pin 21."]
    #[inline]
    pub fn write_gpio_outset_pin21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN22: Pin 22."]
    #[inline]
    pub fn write_gpio_outset_pin22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN23: Pin 23."]
    #[inline]
    pub fn write_gpio_outset_pin23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN24: Pin 24."]
    #[inline]
    pub fn write_gpio_outset_pin24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN25: Pin 25."]
    #[inline]
    pub fn write_gpio_outset_pin25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN26: Pin 26."]
    #[inline]
    pub fn write_gpio_outset_pin26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN27: Pin 27."]
    #[inline]
    pub fn write_gpio_outset_pin27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN28: Pin 28."]
    #[inline]
    pub fn write_gpio_outset_pin28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN29: Pin 29."]
    #[inline]
    pub fn write_gpio_outset_pin29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN30: Pin 30."]
    #[inline]
    pub fn write_gpio_outset_pin30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outset_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].is_out_high())
    }
    #[doc = "GPIO OUTSET PIN31: Pin 31."]
    #[inline]
    pub fn write_gpio_outset_pin31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN0: Pin 0."]
    #[inline]
    pub fn write_gpio_outclr_pin0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN1: Pin 1."]
    #[inline]
    pub fn write_gpio_outclr_pin1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN2: Pin 2."]
    #[inline]
    pub fn write_gpio_outclr_pin2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN3: Pin 3."]
    #[inline]
    pub fn write_gpio_outclr_pin3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN4: Pin 4."]
    #[inline]
    pub fn write_gpio_outclr_pin4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN5: Pin 5."]
    #[inline]
    pub fn write_gpio_outclr_pin5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN6: Pin 6."]
    #[inline]
    pub fn write_gpio_outclr_pin6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN7: Pin 7."]
    #[inline]
    pub fn write_gpio_outclr_pin7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN8: Pin 8."]
    #[inline]
    pub fn write_gpio_outclr_pin8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN9: Pin 9."]
    #[inline]
    pub fn write_gpio_outclr_pin9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN10: Pin 10."]
    #[inline]
    pub fn write_gpio_outclr_pin10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN11: Pin 11."]
    #[inline]
    pub fn write_gpio_outclr_pin11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN12: Pin 12."]
    #[inline]
    pub fn write_gpio_outclr_pin12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN13: Pin 13."]
    #[inline]
    pub fn write_gpio_outclr_pin13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN14: Pin 14."]
    #[inline]
    pub fn write_gpio_outclr_pin14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN15: Pin 15."]
    #[inline]
    pub fn write_gpio_outclr_pin15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN16: Pin 16."]
    #[inline]
    pub fn write_gpio_outclr_pin16(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN17: Pin 17."]
    #[inline]
    pub fn write_gpio_outclr_pin17(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN18: Pin 18."]
    #[inline]
    pub fn write_gpio_outclr_pin18(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN19: Pin 19."]
    #[inline]
    pub fn write_gpio_outclr_pin19(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN20: Pin 20."]
    #[inline]
    pub fn write_gpio_outclr_pin20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN21: Pin 21."]
    #[inline]
    pub fn write_gpio_outclr_pin21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN22: Pin 22."]
    #[inline]
    pub fn write_gpio_outclr_pin22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN23: Pin 23."]
    #[inline]
    pub fn write_gpio_outclr_pin23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN24: Pin 24."]
    #[inline]
    pub fn write_gpio_outclr_pin24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN25: Pin 25."]
    #[inline]
    pub fn write_gpio_outclr_pin25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN26: Pin 26."]
    #[inline]
    pub fn write_gpio_outclr_pin26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN27: Pin 27."]
    #[inline]
    pub fn write_gpio_outclr_pin27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN28: Pin 28."]
    #[inline]
    pub fn write_gpio_outclr_pin28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN29: Pin 29."]
    #[inline]
    pub fn write_gpio_outclr_pin29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN30: Pin 30."]
    #[inline]
    pub fn write_gpio_outclr_pin30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_outclr_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].is_out_high())
    }
    #[doc = "GPIO OUTCLR PIN31: Pin 31."]
    #[inline]
    pub fn write_gpio_outclr_pin31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_in_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].read_input())
    }
    #[doc = "GPIO IN PIN1: Pin 1."]
    #[inline]
    pub fn read_gpio_in_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].read_input())
    }
    #[doc = "GPIO IN PIN2: Pin 2."]
    #[inline]
    pub fn read_gpio_in_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].read_input())
    }
    #[doc = "GPIO IN PIN3: Pin 3."]
    #[inline]
    pub fn read_gpio_in_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].read_input())
    }
    #[doc = "GPIO IN PIN4: Pin 4."]
    #[inline]
    pub fn read_gpio_in_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].read_input())
    }
    #[doc = "GPIO IN PIN5: Pin 5."]
    #[inline]
    pub fn read_gpio_in_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].read_input())
    }
    #[doc = "GPIO IN PIN6: Pin 6."]
    #[inline]
    pub fn read_gpio_in_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].read_input())
    }
    #[doc = "GPIO IN PIN7: Pin 7."]
    #[inline]
    pub fn read_gpio_in_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].read_input())
    }
    #[doc = "GPIO IN PIN8: Pin 8."]
    #[inline]
    pub fn read_gpio_in_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].read_input())
    }
    #[doc = "GPIO IN PIN9: Pin 9."]
    #[inline]
    pub fn read_gpio_in_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].read_input())
    }
    #[doc = "GPIO IN PIN10: Pin 10."]
    #[inline]
    pub fn read_gpio_in_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].read_input())
    }
    #[doc = "GPIO IN PIN11: Pin 11."]
    #[inline]
    pub fn read_gpio_in_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].read_input())
    }
    #[doc = "GPIO IN PIN12: Pin 12."]
    #[inline]
    pub fn read_gpio_in_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].read_input())
    }
    #[doc = "GPIO IN PIN13: Pin 13."]
    #[inline]
    pub fn read_gpio_in_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].read_input())
    }
    #[doc = "GPIO IN PIN14: Pin 14."]
    #[inline]
    pub fn read_gpio_in_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].read_input())
    }
    #[doc = "GPIO IN PIN15: Pin 15."]
    #[inline]
    pub fn read_gpio_in_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].read_input())
    }
    #[doc = "GPIO IN PIN16: Pin 16."]
    #[inline]
    pub fn read_gpio_in_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].read_input())
    }
    #[doc = "GPIO IN PIN17: Pin 17."]
    #[inline]
    pub fn read_gpio_in_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].read_input())
    }
    #[doc = "GPIO IN PIN18: Pin 18."]
    #[inline]
    pub fn read_gpio_in_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].read_input())
    }
    #[doc = "GPIO IN PIN19: Pin 19."]
    #[inline]
    pub fn read_gpio_in_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].read_input())
    }
    #[doc = "GPIO IN PIN20: Pin 20."]
    #[inline]
    pub fn read_gpio_in_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].read_input())
    }
    #[doc = "GPIO IN PIN21: Pin 21."]
    #[inline]
    pub fn read_gpio_in_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].read_input())
    }
    #[doc = "GPIO IN PIN22: Pin 22."]
    #[inline]
    pub fn read_gpio_in_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].read_input())
    }
    #[doc = "GPIO IN PIN23: Pin 23."]
    #[inline]
    pub fn read_gpio_in_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].read_input())
    }
    #[doc = "GPIO IN PIN24: Pin 24."]
    #[inline]
    pub fn read_gpio_in_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].read_input())
    }
    #[doc = "GPIO IN PIN25: Pin 25."]
    #[inline]
    pub fn read_gpio_in_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].read_input())
    }
    #[doc = "GPIO IN PIN26: Pin 26."]
    #[inline]
    pub fn read_gpio_in_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].read_input())
    }
    #[doc = "GPIO IN PIN27: Pin 27."]
    #[inline]
    pub fn read_gpio_in_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].read_input())
    }
    #[doc = "GPIO IN PIN28: Pin 28."]
    #[inline]
    pub fn read_gpio_in_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].read_input())
    }
    #[doc = "GPIO IN PIN29: Pin 29."]
    #[inline]
    pub fn read_gpio_in_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].read_input())
    }
    #[doc = "GPIO IN PIN30: Pin 30."]
    #[inline]
    pub fn read_gpio_in_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].read_input())
    }
    #[doc = "GPIO IN PIN31: Pin 31."]
    #[inline]
    pub fn read_gpio_in_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].read_input())
    }
    #[doc = "GPIO DIR PIN0: Pin 0."]
    #[inline]
    pub fn read_gpio_dir_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].get_direction())
    }
    #[doc = "GPIO DIR PIN0: Pin 0."]
    #[inline]
    pub fn write_gpio_dir_pin0(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[0].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN1: Pin 1."]
    #[inline]
    pub fn read_gpio_dir_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].get_direction())
    }
    #[doc = "GPIO DIR PIN1: Pin 1."]
    #[inline]
    pub fn write_gpio_dir_pin1(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[1].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN2: Pin 2."]
    #[inline]
    pub fn read_gpio_dir_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].get_direction())
    }
    #[doc = "GPIO DIR PIN2: Pin 2."]
    #[inline]
    pub fn write_gpio_dir_pin2(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[2].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN3: Pin 3."]
    #[inline]
    pub fn read_gpio_dir_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].get_direction())
    }
    #[doc = "GPIO DIR PIN3: Pin 3."]
    #[inline]
    pub fn write_gpio_dir_pin3(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[3].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN4: Pin 4."]
    #[inline]
    pub fn read_gpio_dir_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].get_direction())
    }
    #[doc = "GPIO DIR PIN4: Pin 4."]
    #[inline]
    pub fn write_gpio_dir_pin4(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[4].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN5: Pin 5."]
    #[inline]
    pub fn read_gpio_dir_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].get_direction())
    }
    #[doc = "GPIO DIR PIN5: Pin 5."]
    #[inline]
    pub fn write_gpio_dir_pin5(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[5].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN6: Pin 6."]
    #[inline]
    pub fn read_gpio_dir_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].get_direction())
    }
    #[doc = "GPIO DIR PIN6: Pin 6."]
    #[inline]
    pub fn write_gpio_dir_pin6(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[6].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN7: Pin 7."]
    #[inline]
    pub fn read_gpio_dir_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].get_direction())
    }
    #[doc = "GPIO DIR PIN7: Pin 7."]
    #[inline]
    pub fn write_gpio_dir_pin7(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[7].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN8: Pin 8."]
    #[inline]
    pub fn read_gpio_dir_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].get_direction())
    }
    #[doc = "GPIO DIR PIN8: Pin 8."]
    #[inline]
    pub fn write_gpio_dir_pin8(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[8].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN9: Pin 9."]
    #[inline]
    pub fn read_gpio_dir_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].get_direction())
    }
    #[doc = "GPIO DIR PIN9: Pin 9."]
    #[inline]
    pub fn write_gpio_dir_pin9(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[9].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN10: Pin 10."]
    #[inline]
    pub fn read_gpio_dir_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].get_direction())
    }
    #[doc = "GPIO DIR PIN10: Pin 10."]
    #[inline]
    pub fn write_gpio_dir_pin10(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[10].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN11: Pin 11."]
    #[inline]
    pub fn read_gpio_dir_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].get_direction())
    }
    #[doc = "GPIO DIR PIN11: Pin 11."]
    #[inline]
    pub fn write_gpio_dir_pin11(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[11].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN12: Pin 12."]
    #[inline]
    pub fn read_gpio_dir_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].get_direction())
    }
    #[doc = "GPIO DIR PIN12: Pin 12."]
    #[inline]
    pub fn write_gpio_dir_pin12(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[12].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN13: Pin 13."]
    #[inline]
    pub fn read_gpio_dir_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].get_direction())
    }
    #[doc = "GPIO DIR PIN13: Pin 13."]
    #[inline]
    pub fn write_gpio_dir_pin13(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[13].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN14: Pin 14."]
    #[inline]
    pub fn read_gpio_dir_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].get_direction())
    }
    #[doc = "GPIO DIR PIN14: Pin 14."]
    #[inline]
    pub fn write_gpio_dir_pin14(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[14].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN15: Pin 15."]
    #[inline]
    pub fn read_gpio_dir_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].get_direction())
    }
    #[doc = "GPIO DIR PIN15: Pin 15."]
    #[inline]
    pub fn write_gpio_dir_pin15(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[15].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN16: Pin 16."]
    #[inline]
    pub fn read_gpio_dir_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].get_direction())
    }
    #[doc = "GPIO DIR PIN16: Pin 16."]
    #[inline]
    pub fn write_gpio_dir_pin16(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[16].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN17: Pin 17."]
    #[inline]
    pub fn read_gpio_dir_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].get_direction())
    }
    #[doc = "GPIO DIR PIN17: Pin 17."]
    #[inline]
    pub fn write_gpio_dir_pin17(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[17].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN18: Pin 18."]
    #[inline]
    pub fn read_gpio_dir_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].get_direction())
    }
    #[doc = "GPIO DIR PIN18: Pin 18."]
    #[inline]
    pub fn write_gpio_dir_pin18(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[18].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN19: Pin 19."]
    #[inline]
    pub fn read_gpio_dir_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].get_direction())
    }
    #[doc = "GPIO DIR PIN19: Pin 19."]
    #[inline]
    pub fn write_gpio_dir_pin19(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[19].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN20: Pin 20."]
    #[inline]
    pub fn read_gpio_dir_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].get_direction())
    }
    #[doc = "GPIO DIR PIN20: Pin 20."]
    #[inline]
    pub fn write_gpio_dir_pin20(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[20].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN21: Pin 21."]
    #[inline]
    pub fn read_gpio_dir_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].get_direction())
    }
    #[doc = "GPIO DIR PIN21: Pin 21."]
    #[inline]
    pub fn write_gpio_dir_pin21(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[21].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN22: Pin 22."]
    #[inline]
    pub fn read_gpio_dir_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].get_direction())
    }
    #[doc = "GPIO DIR PIN22: Pin 22."]
    #[inline]
    pub fn write_gpio_dir_pin22(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[22].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN23: Pin 23."]
    #[inline]
    pub fn read_gpio_dir_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].get_direction())
    }
    #[doc = "GPIO DIR PIN23: Pin 23."]
    #[inline]
    pub fn write_gpio_dir_pin23(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[23].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN24: Pin 24."]
    #[inline]
    pub fn read_gpio_dir_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].get_direction())
    }
    #[doc = "GPIO DIR PIN24: Pin 24."]
    #[inline]
    pub fn write_gpio_dir_pin24(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[24].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN25: Pin 25."]
    #[inline]
    pub fn read_gpio_dir_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].get_direction())
    }
    #[doc = "GPIO DIR PIN25: Pin 25."]
    #[inline]
    pub fn write_gpio_dir_pin25(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[25].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN26: Pin 26."]
    #[inline]
    pub fn read_gpio_dir_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].get_direction())
    }
    #[doc = "GPIO DIR PIN26: Pin 26."]
    #[inline]
    pub fn write_gpio_dir_pin26(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[26].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN27: Pin 27."]
    #[inline]
    pub fn read_gpio_dir_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].get_direction())
    }
    #[doc = "GPIO DIR PIN27: Pin 27."]
    #[inline]
    pub fn write_gpio_dir_pin27(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[27].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN28: Pin 28."]
    #[inline]
    pub fn read_gpio_dir_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].get_direction())
    }
    #[doc = "GPIO DIR PIN28: Pin 28."]
    #[inline]
    pub fn write_gpio_dir_pin28(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[28].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN29: Pin 29."]
    #[inline]
    pub fn read_gpio_dir_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].get_direction())
    }
    #[doc = "GPIO DIR PIN29: Pin 29."]
    #[inline]
    pub fn write_gpio_dir_pin29(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[29].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN30: Pin 30."]
    #[inline]
    pub fn read_gpio_dir_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].get_direction())
    }
    #[doc = "GPIO DIR PIN30: Pin 30."]
    #[inline]
    pub fn write_gpio_dir_pin30(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[30].set_direction(_value))
    }
    #[doc = "GPIO DIR PIN31: Pin 31."]
    #[inline]
    pub fn read_gpio_dir_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].get_direction())
    }
    #[doc = "GPIO DIR PIN31: Pin 31."]
    #[inline]
    pub fn write_gpio_dir_pin31(&mut self, _value: bool) -> MemResult<()> {
        Ok(self.gpio[31].set_direction(_value))
    }
    #[doc = "GPIO DIRSET PIN0: Set as output pin 0."]
    #[inline]
    pub fn read_gpio_dirset_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].get_direction())
    }
    #[doc = "GPIO DIRSET PIN0: Set as output pin 0."]
    #[inline]
    pub fn write_gpio_dirset_pin0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].get_direction())
    }
    #[doc = "GPIO DIRSET PIN1: Set as output pin 1."]
    #[inline]
    pub fn write_gpio_dirset_pin1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].get_direction())
    }
    #[doc = "GPIO DIRSET PIN2: Set as output pin 2."]
    #[inline]
    pub fn write_gpio_dirset_pin2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].get_direction())
    }
    #[doc = "GPIO DIRSET PIN3: Set as output pin 3."]
    #[inline]
    pub fn write_gpio_dirset_pin3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].get_direction())
    }
    #[doc = "GPIO DIRSET PIN4: Set as output pin 4."]
    #[inline]
    pub fn write_gpio_dirset_pin4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].get_direction())
    }
    #[doc = "GPIO DIRSET PIN5: Set as output pin 5."]
    #[inline]
    pub fn write_gpio_dirset_pin5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].get_direction())
    }
    #[doc = "GPIO DIRSET PIN6: Set as output pin 6."]
    #[inline]
    pub fn write_gpio_dirset_pin6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].get_direction())
    }
    #[doc = "GPIO DIRSET PIN7: Set as output pin 7."]
    #[inline]
    pub fn write_gpio_dirset_pin7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].get_direction())
    }
    #[doc = "GPIO DIRSET PIN8: Set as output pin 8."]
    #[inline]
    pub fn write_gpio_dirset_pin8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].get_direction())
    }
    #[doc = "GPIO DIRSET PIN9: Set as output pin 9."]
    #[inline]
    pub fn write_gpio_dirset_pin9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].get_direction())
    }
    #[doc = "GPIO DIRSET PIN10: Set as output pin 10."]
    #[inline]
    pub fn write_gpio_dirset_pin10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].get_direction())
    }
    #[doc = "GPIO DIRSET PIN11: Set as output pin 11."]
    #[inline]
    pub fn write_gpio_dirset_pin11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].get_direction())
    }
    #[doc = "GPIO DIRSET PIN12: Set as output pin 12."]
    #[inline]
    pub fn write_gpio_dirset_pin12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].get_direction())
    }
    #[doc = "GPIO DIRSET PIN13: Set as output pin 13."]
    #[inline]
    pub fn write_gpio_dirset_pin13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].get_direction())
    }
    #[doc = "GPIO DIRSET PIN14: Set as output pin 14."]
    #[inline]
    pub fn write_gpio_dirset_pin14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].get_direction())
    }
    #[doc = "GPIO DIRSET PIN15: Set as output pin 15."]
    #[inline]
    pub fn write_gpio_dirset_pin15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].get_direction())
    }
    #[doc = "GPIO DIRSET PIN16: Set as output pin 16."]
    #[inline]
    pub fn write_gpio_dirset_pin16(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].get_direction())
    }
    #[doc = "GPIO DIRSET PIN17: Set as output pin 17."]
    #[inline]
    pub fn write_gpio_dirset_pin17(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].get_direction())
    }
    #[doc = "GPIO DIRSET PIN18: Set as output pin 18."]
    #[inline]
    pub fn write_gpio_dirset_pin18(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].get_direction())
    }
    #[doc = "GPIO DIRSET PIN19: Set as output pin 19."]
    #[inline]
    pub fn write_gpio_dirset_pin19(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].get_direction())
    }
    #[doc = "GPIO DIRSET PIN20: Set as output pin 20."]
    #[inline]
    pub fn write_gpio_dirset_pin20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].get_direction())
    }
    #[doc = "GPIO DIRSET PIN21: Set as output pin 21."]
    #[inline]
    pub fn write_gpio_dirset_pin21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].get_direction())
    }
    #[doc = "GPIO DIRSET PIN22: Set as output pin 22."]
    #[inline]
    pub fn write_gpio_dirset_pin22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].get_direction())
    }
    #[doc = "GPIO DIRSET PIN23: Set as output pin 23."]
    #[inline]
    pub fn write_gpio_dirset_pin23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].get_direction())
    }
    #[doc = "GPIO DIRSET PIN24: Set as output pin 24."]
    #[inline]
    pub fn write_gpio_dirset_pin24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].get_direction())
    }
    #[doc = "GPIO DIRSET PIN25: Set as output pin 25."]
    #[inline]
    pub fn write_gpio_dirset_pin25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].get_direction())
    }
    #[doc = "GPIO DIRSET PIN26: Set as output pin 26."]
    #[inline]
    pub fn write_gpio_dirset_pin26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].get_direction())
    }
    #[doc = "GPIO DIRSET PIN27: Set as output pin 27."]
    #[inline]
    pub fn write_gpio_dirset_pin27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].get_direction())
    }
    #[doc = "GPIO DIRSET PIN28: Set as output pin 28."]
    #[inline]
    pub fn write_gpio_dirset_pin28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].get_direction())
    }
    #[doc = "GPIO DIRSET PIN29: Set as output pin 29."]
    #[inline]
    pub fn write_gpio_dirset_pin29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].get_direction())
    }
    #[doc = "GPIO DIRSET PIN30: Set as output pin 30."]
    #[inline]
    pub fn write_gpio_dirset_pin30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirset_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].get_direction())
    }
    #[doc = "GPIO DIRSET PIN31: Set as output pin 31."]
    #[inline]
    pub fn write_gpio_dirset_pin31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin0(&self) -> MemResult<bool> {
        Ok(self.gpio[0].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN0: Set as input pin 0."]
    #[inline]
    pub fn write_gpio_dirclr_pin0(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin1(&self) -> MemResult<bool> {
        Ok(self.gpio[1].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN1: Set as input pin 1."]
    #[inline]
    pub fn write_gpio_dirclr_pin1(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin2(&self) -> MemResult<bool> {
        Ok(self.gpio[2].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN2: Set as input pin 2."]
    #[inline]
    pub fn write_gpio_dirclr_pin2(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin3(&self) -> MemResult<bool> {
        Ok(self.gpio[3].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN3: Set as input pin 3."]
    #[inline]
    pub fn write_gpio_dirclr_pin3(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin4(&self) -> MemResult<bool> {
        Ok(self.gpio[4].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN4: Set as input pin 4."]
    #[inline]
    pub fn write_gpio_dirclr_pin4(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin5(&self) -> MemResult<bool> {
        Ok(self.gpio[5].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN5: Set as input pin 5."]
    #[inline]
    pub fn write_gpio_dirclr_pin5(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin6(&self) -> MemResult<bool> {
        Ok(self.gpio[6].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN6: Set as input pin 6."]
    #[inline]
    pub fn write_gpio_dirclr_pin6(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin7(&self) -> MemResult<bool> {
        Ok(self.gpio[7].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN7: Set as input pin 7."]
    #[inline]
    pub fn write_gpio_dirclr_pin7(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin8(&self) -> MemResult<bool> {
        Ok(self.gpio[8].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN8: Set as input pin 8."]
    #[inline]
    pub fn write_gpio_dirclr_pin8(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin9(&self) -> MemResult<bool> {
        Ok(self.gpio[9].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN9: Set as input pin 9."]
    #[inline]
    pub fn write_gpio_dirclr_pin9(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin10(&self) -> MemResult<bool> {
        Ok(self.gpio[10].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN10: Set as input pin 10."]
    #[inline]
    pub fn write_gpio_dirclr_pin10(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin11(&self) -> MemResult<bool> {
        Ok(self.gpio[11].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN11: Set as input pin 11."]
    #[inline]
    pub fn write_gpio_dirclr_pin11(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin12(&self) -> MemResult<bool> {
        Ok(self.gpio[12].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN12: Set as input pin 12."]
    #[inline]
    pub fn write_gpio_dirclr_pin12(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin13(&self) -> MemResult<bool> {
        Ok(self.gpio[13].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN13: Set as input pin 13."]
    #[inline]
    pub fn write_gpio_dirclr_pin13(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin14(&self) -> MemResult<bool> {
        Ok(self.gpio[14].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN14: Set as input pin 14."]
    #[inline]
    pub fn write_gpio_dirclr_pin14(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin15(&self) -> MemResult<bool> {
        Ok(self.gpio[15].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN15: Set as input pin 15."]
    #[inline]
    pub fn write_gpio_dirclr_pin15(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin16(&self) -> MemResult<bool> {
        Ok(self.gpio[16].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN16: Set as input pin 16."]
    #[inline]
    pub fn write_gpio_dirclr_pin16(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin17(&self) -> MemResult<bool> {
        Ok(self.gpio[17].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN17: Set as input pin 17."]
    #[inline]
    pub fn write_gpio_dirclr_pin17(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin18(&self) -> MemResult<bool> {
        Ok(self.gpio[18].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN18: Set as input pin 18."]
    #[inline]
    pub fn write_gpio_dirclr_pin18(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin19(&self) -> MemResult<bool> {
        Ok(self.gpio[19].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN19: Set as input pin 19."]
    #[inline]
    pub fn write_gpio_dirclr_pin19(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin20(&self) -> MemResult<bool> {
        Ok(self.gpio[20].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN20: Set as input pin 20."]
    #[inline]
    pub fn write_gpio_dirclr_pin20(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin21(&self) -> MemResult<bool> {
        Ok(self.gpio[21].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN21: Set as input pin 21."]
    #[inline]
    pub fn write_gpio_dirclr_pin21(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin22(&self) -> MemResult<bool> {
        Ok(self.gpio[22].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN22: Set as input pin 22."]
    #[inline]
    pub fn write_gpio_dirclr_pin22(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin23(&self) -> MemResult<bool> {
        Ok(self.gpio[23].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN23: Set as input pin 23."]
    #[inline]
    pub fn write_gpio_dirclr_pin23(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin24(&self) -> MemResult<bool> {
        Ok(self.gpio[24].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN24: Set as input pin 24."]
    #[inline]
    pub fn write_gpio_dirclr_pin24(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin25(&self) -> MemResult<bool> {
        Ok(self.gpio[25].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN25: Set as input pin 25."]
    #[inline]
    pub fn write_gpio_dirclr_pin25(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin26(&self) -> MemResult<bool> {
        Ok(self.gpio[26].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN26: Set as input pin 26."]
    #[inline]
    pub fn write_gpio_dirclr_pin26(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin27(&self) -> MemResult<bool> {
        Ok(self.gpio[27].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN27: Set as input pin 27."]
    #[inline]
    pub fn write_gpio_dirclr_pin27(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin28(&self) -> MemResult<bool> {
        Ok(self.gpio[28].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN28: Set as input pin 28."]
    #[inline]
    pub fn write_gpio_dirclr_pin28(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin29(&self) -> MemResult<bool> {
        Ok(self.gpio[29].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN29: Set as input pin 29."]
    #[inline]
    pub fn write_gpio_dirclr_pin29(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin30(&self) -> MemResult<bool> {
        Ok(self.gpio[30].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN30: Set as input pin 30."]
    #[inline]
    pub fn write_gpio_dirclr_pin30(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_dirclr_pin31(&self) -> MemResult<bool> {
        Ok(self.gpio[31].get_direction())
    }
    #[doc = "GPIO DIRCLR PIN31: Set as input pin 31."]
    #[inline]
    pub fn write_gpio_dirclr_pin31(&mut self, _value: bool) -> MemResult<()> {
        if _value {
    ...
    #[inline]
    pub fn read_gpio_pin_cnfn_dir(&self, _dim: usize) -> MemResult<bool> {
    ...
    #[inline]
    pub fn read_gpio_pin_cnfn_input(&self, _dim: usize) -> MemResult<bool> {
        Ok(self.gpio[_dim].get_direction())
    }
    #[doc = "GPIO PIN_CNF[%s] INPUT: Connect or disconnect input path."]
    #[inline]
